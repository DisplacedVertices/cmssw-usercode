...
parser.add_argument('+prescales-fn', help='override minitree tree path', default='root://cmsxrootd.fnal.gov//store/user/tucker/MiniTreeV14_forpick/prescales.root')
parser.add_argument('+prescale-mult', type=float, help='prescale multiplier', default=0.1)
...
process.mfvOverlayTracks = cms.EDFilter('MFVOverlayVertexTracks',
                                        ...
                                        prescale_mult = cms.double(args.prescale_mult),
