...
for sample in samples:
    ps = plot_saver('plots/MFVResolutionsV15/WPixel/FullSelByDistCut/%s' % sample.name, size=(700,700), root=False)
    file = ROOT.TFile('crab/MFVResolutionsV15_10/%s.root' % sample.name)
    print sample.name
