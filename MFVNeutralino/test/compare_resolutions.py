...
histNames = ['h_s_genjets_njets', 'h_s_genjets_ncalojets', 'h_s_genjets_calojetpt4', 'h_s_genjets_jetsumht', 'h_s_partons_njets', 'h_s_partons_ncalojets', 'h_s_partons_calojetpt4', 'h_s_partons_jetsumht', 'h_s_drmin', 'h_s_drmax']

for sample in samples:
    ps = plot_saver('plots/MFVResolutionsV20/genParticles/%s' % sample.name, size=(700,700), root=False)
