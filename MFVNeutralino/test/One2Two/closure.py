...
if is_mc:
    ebin1 = [0.0120, 0.0300, 0.0300, 0.0590] if year == '2015' else [0.0026, 0.0063, 0.0063, 0.0124] if year == '2016' else [0.0025, 0.0062, 0.0062, 0.0120]
    ebin2 = [0.0106, 0.0368, 0.0368, 0.1498] if year == '2015' else [0.0023, 0.0078, 0.0078, 0.0318] if year == '2016' else [0.0023, 0.0077, 0.0077, 0.0308]
    ebin3 = [0.0277, 0.1098, 0.1098, 0.4845] if year == '2015' else [0.0060, 0.0231, 0.0231, 0.1028] if year == '2016' else [0.0059, 0.0227, 0.0227, 0.1011]
elif only_10pc:
