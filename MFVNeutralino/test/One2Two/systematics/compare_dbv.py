...
set_style()
ps = plot_saver('../../plots/bkgest/MinitreeV6p1_76x_nstlays3/dbv', root=False)
trees = '~/crabdirs/MinitreeV6p1_76x_nstlays3'
...
hs_nob = []
for sn in 'qcdht0700 qcdht1000 qcdht1500 qcdht2000'.split():
