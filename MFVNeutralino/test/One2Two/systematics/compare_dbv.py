...
l.AddEntry(h_dbv_sum, '  mean d_{BV} = %4.1f +/- %2.1f #mum' % (10000*h_dbv_sum.GetMean(), 10000*h_dbv_sum.GetRMS()/h_dbv_sum.GetEntries()**0.5), '')
h_dbv_nob.SetStats(0)
h_dbv_nob.SetLineColor(ROOT.kBlue)
h_dbv_nob.SetLineWidth(3)
h_dbv_nob.DrawNormalized('sames')
l.AddEntry(h_dbv_nob, 'background, no b quarks:')
l.AddEntry(h_dbv_nob, '  mean d_{BV} = %4.1f +/- %2.1f #mum' % (10000*h_dbv_nob.GetMean(), 10000*h_dbv_nob.GetRMS()/h_dbv_nob.GetEntries()**0.5), '')
h_dbv_b.SetStats(0)
h_dbv_b.SetLineColor(ROOT.kPink)
h_dbv_b.SetLineWidth(3)
h_dbv_b.DrawNormalized('sames')
l.AddEntry(h_dbv_b, 'background, b quarks:')
l.AddEntry(h_dbv_b, '  mean d_{BV} = %4.1f +/- %2.1f #mum' % (10000*h_dbv_b.GetMean(), 10000*h_dbv_b.GetRMS()/h_dbv_b.GetEntries()**0.5), '')
l.SetFillColor(0)
l.Draw()
ps.save('dbv_b')
