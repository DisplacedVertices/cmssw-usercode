...
l = ROOT.TLegend(0.30,0.65,0.70,0.85)
for i in [3,4,5]:
  f = ROOT.TFile('2v_from_jets_%itrack_average%i_dphijvmin_20umbins.root' % (i,i))
  h1 = f.Get('h_1v_dphijj')
  h2 = f.Get('h_c1v_absdphivv_dphijvmin')
  l.AddEntry(h1, '%i-track %s' % (i,h1.GetXaxis().GetTitle()))
  l.AddEntry(h2, '%i-track %s' % (i,h2.GetXaxis().GetTitle()))
  h1.Rebin(10)
  h2.Rebin(10)
