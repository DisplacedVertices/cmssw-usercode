...
line.Draw()
r = g2.Fit('pol1','S','',-2,-1)
g = ROOT.TGraphErrors(1, array('d',[-0.1]), array('d',[r.Value(0)]), array('d',[0]), array('d',[r.ParError(0)]))
...
t.DrawLatex(-0.1,r.Value(0) - r.ParError(0) - t.GetTextSize(),'%.2f #pm %.2f' % (r.Value(0), r.ParError(0)))
