...
h = f.Get('h_eff_600')
xax = h.GetXaxis()
xax.SetTitle('gluino/neutralino mass (GeV)')
xax.CenterLabels()
xax.SetTitle('gluino/neutralino mass (GeV)')
...
yax = h.GetYaxis()
yax.SetTitle('gluino/neutralino lifetime c#tau')
...
for xxx in ('small', 'big'):
    ...
    yax = h.GetYaxis()
    if xxx == 'small':
        yax.SetTitle('gluino/neutralino lifetime c#tau (#mum)')
    else:
        yax.SetTitle('gluino/neutralino lifetime c#tau (mm)')
    yax.SetTitleOffset(1.25)
