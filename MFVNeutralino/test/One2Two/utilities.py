...
def cmd_merge_btags_nobtags():
    for year in '2017', '2018':
        ...
        if year == '2017' :
            tuple_ntracks_weights                    = (3,'0.83,0.17'), (4,'0.85,0.15'), (5,'0.92,0.08'), (7,'0.83,0.17')
            tuple_ntracks_weights_bcjet_SFs_up       = (3,'0.80,0.20'), (4,'0.82,0.18'), (5,'0.90,0.10'), (7,'0.80,0.20')
            tuple_ntracks_weights_bcjet_SFs_down     = (3,'0.86,0.14'), (4,'0.88,0.12'), (5,'0.94,0.06'), (7,'0.86,0.14')
            tuple_ntracks_weights_ljet_SFs_up        = (3,'0.83,0.17'), (4,'0.85,0.15'), (5,'0.92,0.08'), (7,'0.83,0.17')
            tuple_ntracks_weights_ljet_SFs_down      = (3,'0.83,0.17'), (4,'0.85,0.15'), (5,'0.92,0.08'), (7,'0.83,0.17')
        elif year == '2018' :
            ...
            tuple_ntracks_weights_bcjet_SFs_down     = (3,'0.88,0.12'), (4,'0.92,0.08'), (5,'0.98,0.02'), (7,'0.88,0.12')
