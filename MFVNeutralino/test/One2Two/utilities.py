...
def cmd_merge_btags_nobtags():
    for year in '2017', '2018':
        ...
        if year == '2017' :
            ...
            tuple_ntracks_weights_SFs_flavor_down    = (3,'0.87,0.13'), (4,'0.89,0.11'), (5,'0.95,0.05'), (7,'0.87,0.13')
            tuple_ntracks_weights_SFs_flavor_up      = (3,'0.80,0.20'), (4,'0.83,0.17'), (5,'0.91,0.09'), (7,'0.80,0.20')
        elif year == '2018' :
            ...
            tuple_ntracks_weights_SFs_flavor_down    = (3,'0.89,0.11'), (4,'0.92,0.08'), (5,'0.98,0.02'), (7,'0.89,0.11')
