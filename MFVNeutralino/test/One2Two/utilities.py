...
def cmd_merge_btags_nobtags():
    for year in '2017', '2018':
        ...
        if year == '2017' :
            ...
            tuple_ntracks_weights_SFs_flavor_down    = (3,'0.85,0.15'), (4,'0.87,0.13'), (5,'0.94,0.06'), (7,'0.85,0.15')
            tuple_ntracks_weights_SFs_flavor_up      = (3,'0.81,0.19'), (4,'0.84,0.16'), (5,'0.92,0.08'), (7,'0.82,0.18')
        elif year == '2018' :
            ...
            tuple_ntracks_weights_SFs_flavor_down    = (3,'0.88,0.12'), (4,'0.91,0.09'), (5,'0.98,0.02'), (7,'0.88,0.12')
            tuple_ntracks_weights_SFs_flavor_up      = (3,'0.85,0.15'), (4,'0.89,0.11'), (5,'0.96,0.04'), (7,'0.85,0.15')
        else :
