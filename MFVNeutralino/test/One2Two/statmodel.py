ebins = {
    "MCscaled_2016APV_3track"        : (0.0073, 0.0086, 0.0329), #FIXME
    "MCscaled_2016APV_4track"        : (0.0167, 0.0231, 0.1032), #FIXME
    "MCscaled_2016APV_5track"        : (0.0563, 0.1073, 0.3836), #FIXME
    "MCscaled_2016_3track"        : (0.0073, 0.0086, 0.0329), #FIXME
    "MCscaled_2016_4track"        : (0.0167, 0.0231, 0.1032), #FIXME
    "MCscaled_2016_5track"        : (0.0563, 0.1073, 0.3836), #FIXME
    ...
    "MCscaled_run2_3track"      : (0.0055, 0.0058, 0.0247),   #FIXME
    "MCscaled_run2_4track"      : (0.0121, 0.0148, 0.0779),   #FIXME
    "MCscaled_run2_5track"      : (0.0411, 0.0471, 0.1901),   #FIXME
    "MCeffective_2016APV_3track"     : (0.0110, 0.0128, 0.0488), #FIXME
    "MCeffective_2016APV_4track"     : (0.0246, 0.0336, 0.1504), #FIXME
    "MCeffective_2016APV_5track"     : (0.0818, 0.1556, 0.5553), #FIXME
    "MCeffective_2016_3track"     : (0.0110, 0.0128, 0.0488), #FIXME
    "MCeffective_2016_4track"     : (0.0246, 0.0336, 0.1504), #FIXME
    "MCeffective_2016_5track"     : (0.0818, 0.1556, 0.5553), #FIXME
    ...
    "MCeffective_run2_3track"   : (0.0089, 0.0095, 0.0398),   #FIXME
    "MCeffective_run2_4track"   : (0.0192, 0.0235, 0.1233),   #FIXME
    "MCeffective_run2_5track"   : (0.0689, 0.0779, 0.3099),   #FIXME
...
ebins["data100pc_2016APV_5track"] = (0.02, 0.05, 0.18) # FIXME manual entry from last values used in run2_paper1--don't drop this line when pasting the output of __main__.parse
...
if __name__ == '__main__':
    ...
    if 'parse' in sys.argv:
        ...
        for fn in sorted([s for s in sys.argv[1:] if s.endswith('.root')], key=_ksort):
            f = ROOT.TFile(fn)
            hn = f.Get('h_2v_sumdbvc_bins_rmses')
            hd = f.Get('h_true_2v_sumdbv_norm')
