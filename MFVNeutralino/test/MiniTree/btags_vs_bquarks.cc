...
TH1F* h_1v_btag_flavor_code[2][3] = {{0,0,0},{0,0,0}};
TH2F* h_1v_btag_flavor_code_vs_bquark_flavor_code[2][3] = {{0,0,0},{0,0,0}};
TH1F* h_1v_btag_flavor_code_bquarks[2][3] = {{0,0,0},{0,0,0}};
TH1F* h_1v_btag_flavor_code_nobquarks[2][3] = {{0,0,0},{0,0,0}};
TH1F* h_1v_bquark_flavor_code_btag[2][3] = {{0,0,0},{0,0,0}};
TH1F* h_1v_bquark_flavor_code_nobtag[2][3] = {{0,0,0},{0,0,0}};

TH1F* h_1v_dbv = 0;
TH1F* h_1v_dbv_bquarks = 0;
TH1F* h_1v_dbv_nobquarks = 0;
TH1F* h_1v_dbv_btag[2][3] = {{0,0,0},{0,0,0}};
TH1F* h_1v_dbv_btag_bquarks[2][3] = {{0,0,0},{0,0,0}};
TH1F* h_1v_dbv_btag_nobquarks[2][3] = {{0,0,0},{0,0,0}};
TH1F* h_1v_dbv_nobtag[2][3] = {{0,0,0},{0,0,0}};
TH1F* h_1v_dbv_nobtag_bquarks[2][3] = {{0,0,0},{0,0,0}};
TH1F* h_1v_dbv_nobtag_nobquarks[2][3] = {{0,0,0},{0,0,0}};
