...
sample_files(process, 'ZH_HToSSTodddd_ZToll_tau001000um_M15_2017' if is_mc else 'JetHT2017B', dataset, 100)
#sample_files(process, 'mfv_neu_tau001000um_M1200_2017', dataset, 100)
...
if __name__ == '__main__' and hasattr(sys, 'argv') and 'submit' in sys.argv:
    ...
    if use_btag_triggers :
        #samples = pick_samples(dataset, qcd=True, ttbar=False, span_signal=True, data=False, bjet=True) # no data currently; no sliced ttbar since inclusive is usedS
        samples = Samples.ZH_HToSSTodddd_ZToll_samples_2017 + Samples.WplusH_HToSSTodddd_WToLNu_samples_2017
    ...
    cs = CondorSubmitter('HistosNoPresel' + version,
                         ex = year,
                         dataset = dataset,
