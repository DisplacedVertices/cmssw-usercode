...
#sample_files(process, 'qcdht1000_2017' if is_mc else 'JetHT2017B', dataset, 1)
...
if __name__ == '__main__' and hasattr(sys, 'argv') and 'submit' in sys.argv:
    ...
    if use_btag_triggers :
        ...
        #samples = pick_samples(dataset, qcd=True, ttbar=True, span_signal=False, all_signal=False, data=False, bjet=False)
        #samples = [getattr(Samples, 'mfv_stopdbardbar_tau001000um_M1600_2017')]
        samples = [getattr(Samples, 'mfv_neu_tau001000um_M1600_2017')]
        pset_modifier = chain_modifiers(is_mc_modifier, per_sample_pileup_weights_modifier())
