...
'''.replace('EX1', EX1)
    ...
    for name, cut in nm1s:
        ...
        for nv in nvs:
            ...
            vtx_hst = process.mfvVertexHistos.clone(vertex_src = vtx_name) # beaware that VertexHistosPreSel folders can have tight vertex selection cuts applied from vertex_src
