...
input_files(process, 'root://cmseos.fnal.gov//store/group/lpcdisplacedvertices/joeyr/TTJets_TuneCP5_13TeV-amcatnloFXFX-pythia8/Ntuple_tag003BvetoLHTm_2018/260724_001520/0001/ntuple_1000.root')
...
if __name__ == '__main__' and hasattr(sys, 'argv') and 'submit' in sys.argv:
    ...
    if  use_BTagDispJet_vetoLepHT_triggers:
        ...
        if is_mc :
            samples = pick_samples(dataset, all_lep_signal=False, qcd_lep=True, leptonic=True, ttbar=True, diboson=True)
            pset_modifier = chain_modifiers(is_mc_modifier, per_sample_pileup_weights_modifier(), ttH_duplicate_check_modifier)
        else :
