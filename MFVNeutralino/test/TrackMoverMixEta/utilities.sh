...
#cd "/uscms/home/pkotamni/nobackup/crabdirs/TrackMover_MixEta_NoPreSelRelaxBSPNotwVetodR0p4JetByJetHistsOnnormdzulv30bmofftosspreselv8_20_noCorrection"
...
#cd "/uscms/home/pkotamni/nobackup/crabdirs/TrackMoverMCTruth_MixEta_HighdVV_NoPreSelRelaxBSPVetodR0p4VetoMissLLPVetoTrkJetByMiniJetHistsOnnormdzUlv30bmpreselv6"
#mhadd . --ignore-done & 
#cd "/uscms/home/pkotamni/nobackup/crabdirs/TrackMoverMCTruth_MixEta_LowdVV_NoPreSelRelaxBSPVetodR0p4VetoMissLLPVetoTrkJetByMiniJetHistsOnnormdzUlv30bmpreselv6"
#mhadd . --ignore-done & 
...
#cd "/uscms/home/pkotamni/nobackup/crabdirs/TrackMover_MixEta_NoPreSelRelaxBSPNotwVetodR0p4JetByJetHistsOnnormdzulv30lepmumv8_20_tau000300um_M40_2DCorrection"
#rm -rf *leptonpresel*2016*
...
do
    for mass in 40 #15 55
    do
      cd "/uscms/home/pkotamni/nobackup/crabdirs/TrackMover_MixEta_NoPreSelRelaxBSPNotwVetodR0p4JetByJetHistsOnnormdzulv30bmofftosspreselv8_ggH_20_tau${tau}um_M${mass}_2DCorrection"
      #~/work/CMSSW_10_6_27/src/JMTucker/MFVNeutralino/test/utilities_20161.py leptonpresel histos 20161 &
      #~/work/CMSSW_10_6_27/src/JMTucker/MFVNeutralino/test/utilities_20162.py leptonpresel histos 20162 &
      #rm -rf *leptonpresel*2016*
      #rm -rf SingleMuon20161.root*
...
#    do
#      cd "/uscms/home/pkotamni/nobackup/crabdirs/TrackMover_MixEta_NoPreSelRelaxBSPNotwVetodR0p4JetByJetHistsOnnormdzulv30lepmumv8_20_tau${tau}um_M${mass}_2DCorrection"
      #~/work/CMSSW_10_6_27/src/JMTucker/MFVNeutralino/test/utilities_20161.py leptonpresel histos 20161 &
      #~/work/CMSSW_10_6_27/src/JMTucker/MFVNeutralino/test/utilities_20162.py leptonpresel histos 20162 &
      #rm -rf *leptonpresel*2016*
      #rm -rf SingleMuon20161.root*
