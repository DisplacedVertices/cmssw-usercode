...
def _background_samples(trigeff=False, year=2017):
    if _leptonpresel or trigeff:
        ...
        #x = ['qcdbenrichedht%04i' % x for x in [300, 500, 700, 1000]]
        #x += ['qcdbenrichedht%04iext' % x for x in [300, 500, 700, 1000]]
        #x += ['qcdbgenfilterht%04i' % x for x in [300, 500, 700, 1000]]
        #x += ['qcdbgenfilterht%04iext' % x for x in [700]]
        x += ['ttbar']
    else:
