...
fn1 = '/uscms_data/d2/tucker/crab_dirs/MiniTreeV20mp2/mfv_stopdbardbar_tau030000um_M1600_2017.root'
fn2 = '/uscms_data/d2/tucker/crab_dirs/MiniNtupleV20m/mfv_stopdbardbar_cp2_tau030000um_M1600_2017.root'
nice1 = 'CP5'
nice2 = 'CP2'
one2one = False # whether to compare result event by event (must be same events but processed differently)
scale1, scale2 = 1., 0.5  # not smart enough to figure out the appropriate scaling by e.g. nevents generated
