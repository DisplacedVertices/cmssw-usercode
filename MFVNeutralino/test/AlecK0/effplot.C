void effplot()
{
  ...
  TString file_dir = "/uscms/home/alecduqu/crab_dirs/histsp10_k0ntupleulv1bmv2_summer20ul_miniaodv2/bkgsub_roots/";
  //TString out_dir = "/uscms/home/joeyr/publicweb/plots/K0study_2017/";   Alec commented
  TString out_dir = "/uscms/home/alecduqu/crab_dirs/histsp10_k0ntupleulv1bmv2_summer20ul_miniaodv2/bkgsub_roots/";
  TString fnmc = "background_btagpresel_"+year+".root";
  TString fndata = "BTagCSV"+year+".root";
  //TString fndata = "JetHT"+year+".root";
  int rebin = 60;
  int nbins = 10;
  ...
  rp->GetLowerRefGraph()->SetMaximum(1.15); Alec commented*/
