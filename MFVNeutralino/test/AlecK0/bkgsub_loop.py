...
pt_names = ["pt_lt3", "pt_gt3lt5", "pt_gt5lt8", "pt_gt8"]
dxy_names = ["dxy_ltp05", "dxy_gtp05ltp1", "dxy_gtp1ltp15", "dxy_gtp15ltp2", "dxy_gtp2ltp25", "dxy_gtp25ltp3", "dxy_gtp3ltp4", "dxy_gtp4"]
...
for pt in pt_names:
    ...
    for dxy in dxy_names:
        ...
        h = in_f.Get('massall/'+pt+'/'+dxy+'/h_mass')
        ...
        for hname, integ_factor, rebin, x_range, scan_dir in variables:
            ...
            hon = in_f.Get('masson/%s/%s/%s' % (pt, dxy, hname))
            hbkglo = in_f.Get('masslo/%s/%s/%s' % (pt, dxy, hname))
            hbkghi = in_f.Get('masshi/%s/%s/%s' % (pt, dxy, hname))
