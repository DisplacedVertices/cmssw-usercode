...
#cd "/uscms/home/pkotamni/nobackup/crabdirs/TrackMover_HighEta_NoPreSelRelaxBSPNotwVetodR0p4JetByJetHistsOnnormdzulv30bmofftosspreselv8_20_noCorrection"
...
#cd "/uscms/home/pkotamni/nobackup/crabdirs/TrackMoverMCTruth_HighEta_HighdVV_NoPreSelRelaxBSPVetodR0p4VetoMissLLPVetoTrkJetByMiniJetHistsOnnormdzUlv30bmpreselv6"
#mhadd . --ignore-done & 
#cd "/uscms/home/pkotamni/nobackup/crabdirs/TrackMoverMCTruth_HighEta_LowdVV_NoPreSelRelaxBSPVetodR0p4VetoMissLLPVetoTrkJetByMiniJetHistsOnnormdzUlv30bmpreselv6"
#mhadd . --ignore-done & 
...
#cd "/uscms/home/pkotamni/nobackup/crabdirs/TrackMover_HighEta_NoPreSelRelaxBSPNotwVetodR0p4JetByJetHistsOnnormdzulv30lepmumv8_20_tau000300um_M40_2DCorrection"
#rm -rf *leptonpresel*2016*
...
do
    ...
    do
      cd "/uscms/home/pkotamni/nobackup/crabdirs/TrackMover_HighEta_NoPreSelRelaxBSPNotwVetodR0p4JetByJetHistsOnnormdzulv30bmofftosspreselv8_ggH_20_tau${tau}um_M${mass}_2DCorrection"
      #~/work/CMSSW_10_6_27/src/JMTucker/MFVNeutralino/test/utilities_20161.py leptonpresel histos 20161 &
      #~/work/CMSSW_10_6_27/src/JMTucker/MFVNeutralino/test/utilities_20162.py leptonpresel histos 20162 &
      #rm -rf *btagpresel*
      #rm -rf DisplacedJet2018.root*
      #rm -rf DisplacedJet2017.root*
      #rm -rf DisplacedJet20161.root*
      #rm -rf DisplacedJet20162.root*
      #rm -rf JetHT2018.root*
      #rm -rf BTagCSV2017.root*
