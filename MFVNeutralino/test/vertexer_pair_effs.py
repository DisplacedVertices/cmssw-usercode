...
dataset = 'ntuplev28bm_noveto', #FIXME
...
if __name__ == '__main__' and hasattr(sys, 'argv') and 'submit' in sys.argv:
    ...
    if use_btag_triggers :
        samples = pick_samples(dataset, qcd=True, ttbar=True, span_signal=True, data=False, bjet=True) # no data currently; no sliced ttbar since inclusive is used
