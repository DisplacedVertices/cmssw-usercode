...
process.pVertices = cms.Path(process.mfvSelectedVertices * process.mfvResolutionsVertices)

process.mfvResolutionsGeo2ddist = mfvResolutions.clone(vertex_src = 'mfvSelectedVerticesGeo2ddist')
process.pGeo2ddist = cms.Path(process.mfvSelectedVerticesGeo2ddist * process.mfvResolutionsGeo2ddist)

process.mfvResolutionsNtracks = mfvResolutions.clone(vertex_src = 'mfvSelectedVerticesNtracks')
process.pNtracks = cms.Path(process.mfvSelectedVerticesNtracks * process.mfvResolutionsNtracks)

process.mfvResolutionsBs2derr = mfvResolutions.clone(vertex_src = 'mfvSelectedVerticesBs2derr')
process.pBs2derr = cms.Path(process.mfvSelectedVerticesBs2derr * process.mfvResolutionsBs2derr)

process.mfvResolutionsMindrmax = mfvResolutions.clone(vertex_src = 'mfvSelectedVerticesMindrmax')
process.pMindrmax = cms.Path(process.mfvSelectedVerticesMindrmax * process.mfvResolutionsMindrmax)

process.mfvResolutionsMaxdrmax = mfvResolutions.clone(vertex_src = 'mfvSelectedVerticesMaxdrmax')
process.pMaxdrmax = cms.Path(process.mfvSelectedVerticesMaxdrmax * process.mfvResolutionsMaxdrmax)

process.mfvResolutionsDrmin = mfvResolutions.clone(vertex_src = 'mfvSelectedVerticesDrmin')
process.pDrmin = cms.Path(process.mfvSelectedVerticesDrmin * process.mfvResolutionsDrmin)

process.mfvResolutionsNjetsntks = mfvResolutions.clone(vertex_src = 'mfvSelectedVerticesNjetsntks')
process.pNjetsntks = cms.Path(process.mfvSelectedVerticesNjetsntks * process.mfvResolutionsNjetsntks)

process.mfvResolutionsNtracksptgt3 = mfvResolutions.clone(vertex_src = 'mfvSelectedVerticesNtracksptgt3')
process.pNtracksptgt3 = cms.Path(process.mfvSelectedVerticesNtracksptgt3 * process.mfvResolutionsNtracksptgt3)
