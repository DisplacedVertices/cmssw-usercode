...
if study_new_triggers :
    #num_file_dir = '/uscms_data/d3/shogan/crab_dirs/HistosULV4Bm_TrigStudy_July11_MoreTrigEffs_On'
    #den_file_dir = '/uscms_data/d3/shogan/crab_dirs/HistosULV4Bm_TrigStudy_July11_MoreTrigEffs_Off'
    num_file_dir = '/uscms_data/d3/shogan/crab_dirs/HistosULV4Bm_TrigStudy_July13_DispTkVetoOnly_On'
    den_file_dir = '/uscms_data/d3/shogan/crab_dirs/HistosULV4Bm_TrigStudy_July13_DispTkVetoOnly_Off'
    trigs = ['Logical OR']
    nice = ['Logical OR']
...
def getit(fnum, fden):
    ...
    hden = fden.Get('mfvEventHistosBjetAgnost/h_npu')
    nnum = hnum.Integral()
    nden = hden.Integral()
    if nden < 0.1:
        return 0.0, 0.0, 0.0
    ...
    #return clopper_pearson(hnum.Integral(), hnum.Integral())
