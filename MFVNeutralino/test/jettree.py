...
from JMTucker.MFVNeutralino.NtupleCommon import ntuple_version_use as version, dataset, use_BTagDispJet_vetoLepHT_triggers, use_MET_triggers
...
sample_files(process, 'ttbar_2017' if is_mc else 'JetHT2017B', dataset, 10)
#input_files(process,[
...
process.mfvAnalysisCutsJetTree = process.mfvAnalysisCuts.clone(vertex_src = 'mfvSelectedVerticesExtraLoose', min_nvertex = 1)
...
process.pJetTreer = cms.Path(process.mfvWeight * process.mfvSelectedVerticesSeq * process.mfvAnalysisCutsJetTree * process.mfvJetTreer)
...
if __name__ == '__main__' and hasattr(sys, 'argv') and 'submit' in sys.argv:
    ...
    cs = CondorSubmitter('MLTree' + version,
                         ex = year,
                         dataset = dataset,
                         stageout_files = 'all',
