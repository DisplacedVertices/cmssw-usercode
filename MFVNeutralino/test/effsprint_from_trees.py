...
for ntk in ['mfvMiniTree', 'tre33', 'tre34', 'tre44']:
    ...
    for sample in background_samples:
        ...
        print '%24s %d %9.3f %8d %8.5f raw n1v = %6d +/- %3d, weighted n1v = %9.2f +/- %6.2f, raw n2v = %4d +/- %2d, weighted n2v = %7.2f +/- %5.2f' % (sample.name, int_lumi, sample.xsec, sample.nevents_orig, w, n1v, n1v**0.5, w*n1v, w*n1v**0.5, n2v, n2v**0.5, w*n2v, w*n2v**0.5)
        raw_n1v += n1v
        sum_n1v += n1v * w
        var_n1v += n1v * w**2
        raw_n2v += n2v
