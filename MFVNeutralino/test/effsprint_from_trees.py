...
for ntk in ['', '_ntk3', '_ntk3or4', '_ntk4']:
    ...
    for sample in Samples.qcd_samples_sum + Samples.ttbar_samples:
        ...
        print '%24s %d %7.1f %8d %4.1f raw n1v = %6d +/- %3d, weighted n1v = %9.2f +/- %7.2f, raw n2v = %4d +/- %2d, weighted n2v = %7.2f +/- %5.2f' % (sample.name, ac.int_lumi, sample.xsec, sample.nevents_orig, w, n1v, n1v**0.5, w*n1v, w*n1v**0.5, n2v, n2v**0.5, w*n2v, w*n2v**0.5)
        raw_n1v += n1v
        sum_n1v += n1v * w
        var_n1v += n1v * w**2
        raw_n2v += n2v
        sum_n2v += n2v * w
        var_n2v += n2v * w**2
    print '%24s %d %7s %8s %4s raw n1v = %6d %7s, weighted n1v = %9.2f +/- %7.2f, raw n2v = %4d %6s, weighted n2v = %7.2f +/- %5.2f' % ('total background', ac.int_lumi, '', '', '', raw_n1v, '', sum_n1v, var_n1v**0.5, raw_n2v, '', sum_n2v, var_n2v**0.5)
    print
