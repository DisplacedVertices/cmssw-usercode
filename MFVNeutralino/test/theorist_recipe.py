...
process.pNoCuts = cms.Path(process.mfvTheoristRecipeNoCuts)

process.mfvAnalysisCutsTrigSel = process.mfvAnalysisCuts.clone(apply_cleaning_filters = False, min_4th_calojet_pt = 0, min_njets = 0, min_ht = 0, apply_vertex_cuts = False)
process.mfvTheoristRecipeTrigSel = mfvTheoristRecipe.clone()
process.pTrigSel = cms.Path(process.mfvAnalysisCutsTrigSel * process.mfvTheoristRecipeTrigSel)

process.mfvAnalysisCutsCleaningFilters = process.mfvAnalysisCuts.clone(min_4th_calojet_pt = 0, min_njets = 0, min_ht = 0, apply_vertex_cuts = False)
process.mfvTheoristRecipeCleaningFilters = mfvTheoristRecipe.clone()
process.pCleaningFilters = cms.Path(process.mfvAnalysisCutsCleaningFilters * process.mfvTheoristRecipeCleaningFilters)
...
process.pOfflineJets = cms.Path(process.mfvAnalysisCutsOfflineJets * process.mfvTheoristRecipeOfflineJets)
...
process.pPreSel = cms.Path(process.mfvAnalysisCutsPreSel * process.mfvTheoristRecipePreSel)
...
process.pTwoVtxNoCuts = cms.Path(process.mfvSelectedVertices * process.mfvAnalysisCutsTwoVtxNoCuts * process.mfvTheoristRecipeTwoVtxNoCuts)
...
process.pTwoVtxGeo2ddist = cms.Path(process.mfvSelectedVerticesGeo2ddist * process.mfvAnalysisCutsTwoVtxGeo2ddist * process.mfvTheoristRecipeTwoVtxGeo2ddist)
...
process.pTwoVtxNtracks = cms.Path(process.mfvSelectedVerticesNtracks * process.mfvAnalysisCutsTwoVtxNtracks * process.mfvTheoristRecipeTwoVtxNtracks)
...
process.pTwoVtxBs2derr = cms.Path(process.mfvSelectedVerticesBs2derr * process.mfvAnalysisCutsTwoVtxBs2derr * process.mfvTheoristRecipeTwoVtxBs2derr)
...
process.pTwoVtxMindrmax = cms.Path(process.mfvSelectedVerticesMindrmax * process.mfvAnalysisCutsTwoVtxMindrmax * process.mfvTheoristRecipeTwoVtxMindrmax)
...
process.pTwoVtxMaxdrmax = cms.Path(process.mfvSelectedVerticesMaxdrmax * process.mfvAnalysisCutsTwoVtxMaxdrmax * process.mfvTheoristRecipeTwoVtxMaxdrmax)
...
process.pTwoVtxDrmin = cms.Path(process.mfvSelectedVerticesDrmin * process.mfvAnalysisCutsTwoVtxDrmin * process.mfvTheoristRecipeTwoVtxDrmin)
...
process.pTwoVtxNjetsntks = cms.Path(process.mfvSelectedVerticesNjetsntks * process.mfvAnalysisCutsTwoVtxNjetsntks * process.mfvTheoristRecipeTwoVtxNjetsntks)
...
process.pTwoVtxNtracksptgt3 = cms.Path(process.mfvSelectedVerticesNtracksptgt3 * process.mfvAnalysisCutsTwoVtxNtracksptgt3 * process.mfvTheoristRecipeTwoVtxNtracksptgt3)
...
process.pTwoVtxDvv600um = cms.Path(process.mfvSelectedVerticesTight * process.mfvAnalysisCutsDvv600um * process.mfvTheoristRecipeTwoVtxDvv600um)

process.mfvTheoristRecipeVertices = mfvTheoristRecipe.clone(vertex_src = 'mfvSelectedVertices')
process.pVertices = cms.Path(process.mfvAnalysisCutsPreSel * process.mfvSelectedVertices * process.mfvTheoristRecipeVertices)

process.mfvTheoristRecipeGeo2ddist = mfvTheoristRecipe.clone(vertex_src = 'mfvSelectedVerticesGeo2ddist')
process.pGeo2ddist = cms.Path(process.mfvAnalysisCutsPreSel * process.mfvSelectedVerticesGeo2ddist * process.mfvTheoristRecipeGeo2ddist)

process.mfvTheoristRecipeNtracks = mfvTheoristRecipe.clone(vertex_src = 'mfvSelectedVerticesNtracks')
process.pNtracks = cms.Path(process.mfvAnalysisCutsPreSel * process.mfvSelectedVerticesNtracks * process.mfvTheoristRecipeNtracks)

process.mfvTheoristRecipeBs2derr = mfvTheoristRecipe.clone(vertex_src = 'mfvSelectedVerticesBs2derr')
process.pBs2derr = cms.Path(process.mfvAnalysisCutsPreSel * process.mfvSelectedVerticesBs2derr * process.mfvTheoristRecipeBs2derr)

process.mfvTheoristRecipeMindrmax = mfvTheoristRecipe.clone(vertex_src = 'mfvSelectedVerticesMindrmax')
process.pMindrmax = cms.Path(process.mfvAnalysisCutsPreSel * process.mfvSelectedVerticesMindrmax * process.mfvTheoristRecipeMindrmax)

process.mfvTheoristRecipeMaxdrmax = mfvTheoristRecipe.clone(vertex_src = 'mfvSelectedVerticesMaxdrmax')
process.pMaxdrmax = cms.Path(process.mfvAnalysisCutsPreSel * process.mfvSelectedVerticesMaxdrmax * process.mfvTheoristRecipeMaxdrmax)

process.mfvTheoristRecipeDrmin = mfvTheoristRecipe.clone(vertex_src = 'mfvSelectedVerticesDrmin')
process.pDrmin = cms.Path(process.mfvAnalysisCutsPreSel * process.mfvSelectedVerticesDrmin * process.mfvTheoristRecipeDrmin)

process.mfvTheoristRecipeNjetsntks = mfvTheoristRecipe.clone(vertex_src = 'mfvSelectedVerticesNjetsntks')
process.pNjetsntks = cms.Path(process.mfvAnalysisCutsPreSel * process.mfvSelectedVerticesNjetsntks * process.mfvTheoristRecipeNjetsntks)

process.mfvTheoristRecipeNtracksptgt3 = mfvTheoristRecipe.clone(vertex_src = 'mfvSelectedVerticesNtracksptgt3')
process.pNtracksptgt3 = cms.Path(process.mfvAnalysisCutsPreSel * process.mfvSelectedVerticesNtracksptgt3 * process.mfvTheoristRecipeNtracksptgt3)
...
process.pNoNtracksBs2derrNtracksptgt3 = cms.Path(process.mfvAnalysisCutsPreSel * process.mfvSelectedVerticesNoNtracksBs2derrNtracksptgt3 * process.mfvTheoristRecipeNoNtracksBs2derrNtracksptgt3)
...
if __name__ == '__main__' and hasattr(sys, 'argv') and 'submit' in sys.argv:
    ...
    if mode == '2Ntbs':
        ...
        cs = CRABSubmitter('MFVTheoristRecipe',
