...
process.mfvGenParticleFilterFourJetsPt0 = process.mfvGenParticleFilter.clone(min_npartons = 4)
process.mfvGenFourJetsPt0 = mfvTheoristRecipe.clone()
process.pGenFourJetsPt0 = cms.Path(process.common * process.mfvGenParticleFilterFourJetsPt0 * process.mfvGenFourJetsPt0)
