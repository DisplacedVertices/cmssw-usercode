...
def cmd_merge_background(permissive=bool_from_argv('permissive'), year_to_use=2017):
    ...
    if year_to_use==-1:
      ...
      if ok:
        ...
        year = int(year_s[1:])
        print 'scaling to', year, scale
        for bkg_tag in ['wjetstolnu', 'ttbar', 'dyjets', 'dibosons']:#, 'qcdmupt5', 'dyjets', 'ttbar', 'dibosons'] : # ['others', 'wjetstolnu', 'qcd', 'qcdmupt5', 'dyjets'] : #FIXME
