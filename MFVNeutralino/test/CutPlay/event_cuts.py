...
process.trignjetsht500 = cuts.clone(min_sum_ht = 500)
process.trignjetsht750 = cuts.clone(min_sum_ht = 750)
process.trigmu = cuts.clone(trigger_bit = 3, min_4th_jet_pt = 20)
process.trigmuht500 = cuts.clone(trigger_bit = 3, min_4th_jet_pt = 20, min_sum_ht = 500)
...
process.trigtopmunmuht500 = cuts.clone(trigger_bit = 4, min_4th_jet_pt = 20, min_nsemilepmuons = 1, min_sum_ht = 500)
...
if __name__ == '__main__' and hasattr(sys, 'argv') and 'submit' in sys.argv:
    ...
    samples = Samples.qcd_samples + Samples.ttbar_samples + Samples.mfv_signal_samples
