...
for nl in 2,: # 3:
    for nb in 0,: # 1, 2:
      for tau in [300,]: #[100, 300, 1000, 3000, 10000, 30000]: # 300] : #[100, 300,1000, 3000, 30000] :
        for mg in [400,]: #[15, 40, 55,]: # 40, 55,] : #[15,40,55,]:
          if apply_correction:
            for tm in ["sim", "dat"] :
              w_fn_2d_move = ""
              if tm == "sim":
                ...
                samples = pick_samples(dataset, qcd=False, data = False, all_signal = False, qcd_lep=False, leptonic=False, ttbar=False, diboson=False, Lepton_data=True, BTagCSV_data=True, DisplacedJet_data=True)
            ...
            samples = pick_samples(dataset, qcd=False, data = False, all_signal = False, qcd_lep=True, leptonic=True, ttbar=True, diboson=True, Lepton_data=True, BTagCSV_data=True, DisplacedJet_data=True)
