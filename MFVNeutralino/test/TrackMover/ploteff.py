...
set_style()
ps = plot_saver(plot_dir('trackmover_V3_effs'), size=(600,600), log=False)
        ...
        for njets in 2,3:
            for nbjets in 0,1,2:
                ...
                p(name, title,
                  ...
                  [(nsig,) + effs(cutset=cutset, nsigmadxy=nsig, tau=tau, njets=njets, nbjets=nbjets, mc=True).eff for nsig in [3.7 + i*0.1 for i in xrange(7)]]
                  )
