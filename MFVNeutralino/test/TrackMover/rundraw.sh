  ...
  do
    ...
    do
     ...
     sigpth3="/uscms/home/pkotamni/nobackup/crabdirs/TrackMoverMCTruth_HighEta_HighdVV_NoPreSelRelaxBSPVetodR0p4VetoMissLLPVetoTrkJetByMiniJetHistsOnnormdzUlv30lepmumv6/VHToSSTodddd_tau${tau_mm}mm_M${mass}_${year}.root"
      python draw.py TM_TOC_Mu_year${year}_ctau${tau}um_mass${mass}_loweta_VHSS4d_ADDTTbar ${pth1}/${bkg} ${pth1}/${data} ${sigpth1} ${sigpth1} ${pth1}/${data} Low
      python draw.py TM_TOC_Mu_year${year}_ctau${tau}um_mass${mass}_mixeta_VHSS4d_ADDTTbar ${pth2}/${bkg} ${pth2}/${data} ${sigpth2} ${sigpth2} ${pth2}/${data} Mix
      python draw.py TM_TOC_Mu_year${year}_ctau${tau}um_mass${mass}_higheta_VHSS4d_ADDTTbar ${pth3}/${bkg} ${pth3}/${data} ${sigpth3} ${sigpth3} ${pth2}/${data} High
    done
