  ...
  do
    ...
    do
     ...
     sigpth3="/uscms/home/pkotamni/nobackup/crabdirs/TrackMoverMCTruth_HighEta_HighdVV0p36_NoPreSelRelaxBSPVetodR0p4VetoMissLLPVetoTrkJetByMiniJetHistsOnnormdzUlv30bmpreselhighptv6/mfv_stopdbardbar_tau${tau}um_M${mass}_${year}.root"
      python drawden.py TM_DENOM_B_year${year}_ctau${tau}um_mass${mass}_loweta_Stopdbardbar ${pth1}/${bkg} ${pth1}/${data} ${sigpth1} ${sigpth1} ${pth1}/${bkg} ${pth1}/${data} long Low
      #python drawden.py TM_DENOM_B_year${year}_ctau${tau}um_mass${mass}_mixeta_Stopdbardbar ${pth2}/${bkg} ${pth2}/${data} ${sigpth2} ${sigpth2} ${pth2}/${bkg} ${pth2}/${data} long Mix
      #python drawden.py TM_DENOM_B_year${year}_ctau${tau}um_mass${mass}_higheta_Stopdbardbar ${pth3}/${bkg} ${pth3}/${data} ${sigpth3} ${sigpth3} ${pth3}/${bkg} ${pth3}/${data} long High
    done
