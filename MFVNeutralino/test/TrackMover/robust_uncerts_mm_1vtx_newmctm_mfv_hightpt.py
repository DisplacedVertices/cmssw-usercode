  ...
  for ctau in ctaus:
    ...
    for eta in ['Low','Mix','High']:
        ...
        for psd_method in psd_methods:
                ...
                if not reweight:
                    sim_str = "~/nobackup/crabdirs/TrackMover_%sEta_NoPreSelRelaxBSPNotwVetodR0p4JetByJetHistsOnnormdzulv30bmofftosspreselhighptv8_20_noCorrection/background_btagpresel_%s.root" % (eta,year)
                    dat_str = "~/nobackup/crabdirs/TrackMover_%sEta_NoPreSelRelaxBSPNotwVetodR0p4JetByJetHistsOnnormdzulv30bmofftosspreselhighptv8_20_noCorrection/BTagDispl%s.root" % (eta,year)
                else:
                    sim_str = "~/nobackup/crabdirs/TrackMover_%sEta_NoPreSelRelaxBSPNotwVetodR0p4JetByJetHistsOnnormdzulv30bmofftosspreselhighptv8_20_tau%06ium_M%i_2DCorrection/background_btagpresel_%s.root" % (eta,int(ctau), int(mass), year)
                    dat_str = "~/nobackup/crabdirs/TrackMover_%sEta_NoPreSelRelaxBSPNotwVetodR0p4JetByJetHistsOnnormdzulv30bmofftosspreselhighptv8_20_tau%06ium_M%i_2DCorrection/BTagDispl%s.root" % (eta,int(ctau), int(mass), year)
                ...
                print(ctau, str_ctau)
                signal  = ROOT.TFile('~/nobackup/crabdirs/TrackMoverMCTruth_'+eta+'Eta_HighdVV0p36_NoPreSelRelaxBSPVetodR0p4VetoMissLLPVetoTrkJetByMiniJetHistsOnnormdzUlv30bmpreselhighptv6/mfv_stopdbardbar_tau'+ctau+'um_M'+mass+'_'+ year +'.root')
                ...
                signal_non  = ROOT.TFile('~/nobackup/crabdirs/TrackMoverMCTruth_'+eta+'Eta_HighdVV0p36_NoPreSelRelaxBSPVetodR0p4VetoMissLLPVetoTrkJetByMiniJetHistsOnnormdzUlv30bmpreselhighptv6/mfv_stopdbardbar_tau'+ctau+'um_M'+mass+'_'+ year +'.root')  
                ...
                signal_vetopdvv  = ROOT.TFile('~/nobackup/crabdirs/TrackMoverMCTruth_'+eta+'Eta_LowdVV0p36_NoPreSelRelaxBSPVetodR0p4VetoMissLLPVetoTrkJetByMiniJetHistsOnnormdzUlv30bmpreselhighptv6/mfv_stopdbardbar_tau'+ctau+'um_M'+mass+'_'+ year +'.root')  
...
ROOT.gPad.Update()
canvas.Update()
ps.save('stopdbardbar_'+str(mass)+'GeV_mmCtau')
...
ROOT.gPad.Update()
canvas2.Update()
ps2.save('stopdbardbar_'+str(mass)+'GeV_mmCtau_relerr')
