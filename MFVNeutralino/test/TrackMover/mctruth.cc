...
int main(int argc, char** argv) {
  ...
  nr.init_options("mfvMovedTreeMCTruth/t", "TrackMoverMCTruthVetoPUPVetoTrkJetByMiniJetHistsOnnormdzUlv30lepmumv5", "trackmovermctruthonnormdzulv30lepmumv5", "all_signal = True")
