  ...
  do
    ...
    do
     ...
     sigpth3="/uscms/home/pkotamni/nobackup/crabdirs/TrackMoverMCTruth_HighEta_HighdVV_NoPreSelRelaxBSPVetodR0p4VetoMissLLPVetoTrkJetByMiniJetHistsOnnormdzUlv30bmpreselv6/ggHToSSTodddd_tau${tau_mm}mm_M${mass}_${year}.root"
      python drawden.py TM_DENOM_B_year${year}_ctau${tau}um_mass${mass}_loweta_ggH_ACTUAL ${pth1}/${bkg} ${pth1}/${data} ${sigpth1} ${sigpth1} ${pth1}/${bkg} ${pth1}/${data} long Low
      #python drawden.py TM_DENOM_B_year${year}_ctau${tau}um_mass${mass}_mixeta_ggH ${pth2}/${bkg} ${pth2}/${data} ${sigpth2} ${sigpth2} ${pth2}/${bkg} ${pth2}/${data} long Mix
      #python drawden.py TM_DENOM_B_year${year}_ctau${tau}um_mass${mass}_higheta_ggH ${pth3}/${bkg} ${pth3}/${data} ${sigpth3} ${sigpth3} ${pth3}/${bkg} ${pth3}/${data} long High
    done
