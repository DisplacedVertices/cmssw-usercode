    ...
    for eta in ['Low','Mix','High']:
        ...
        for psd_method in psd_methods:
                ...
                if not reweight:
                    ...
                    sim_str = "/uscms/home/pkotamni/nobackup/crabdirs/TrackMover_%sEta_NoPreSelRelaxBSPNotwVetodR0p4JetByJetHistsOnnormdzulv30bmofftosspreselhighptv8_StopBbarBbar_20_tau%06ium_M%i_2DCorrection/background_btagpresel_%s.root" % (eta,int(ctau), int(mass), year)
                    dat_str = "/uscms/home/pkotamni/nobackup/crabdirs/TrackMover_%sEta_NoPreSelRelaxBSPNotwVetodR0p4JetByJetHistsOnnormdzulv30bmofftosspreselhighptv8_StopBbarBbar_20_tau%06ium_M%i_2DCorrection/BTagDispl%s.root" % (eta,int(ctau), int(mass), year)
                ...
                #print(ctau, str_ctau)
                signal  = ROOT.TFile('/uscms/home/pkotamni/nobackup/crabdirs/TrackMoverMCTruth_'+eta+'Eta_HighdVV0p36_NoPreSelRelaxBSPVetodR0p4VetoMissLLPVetoTrkJetByMiniJetHistsOnnormdzUlv30bmpreselhighptv6/mfv_stopbbarbbar_tau'+ctau+'um_M'+mass+'_'+ year +'.root')
                ...
                signal_non  = ROOT.TFile('/uscms/home/pkotamni/nobackup/crabdirs/TrackMoverMCTruth_'+eta+'Eta_HighdVV0p36_NoPreSelRelaxBSPVetodR0p4VetoMissLLPVetoTrkJetByMiniJetHistsOnnormdzUlv30bmpreselhighptv6/mfv_stopbbarbbar_tau'+ctau+'um_M'+mass+'_'+ year +'.root')  
                ...
                signal_vetopdvv  = ROOT.TFile('/uscms/home/pkotamni/nobackup/crabdirs/TrackMoverMCTruth_'+eta+'Eta_LowdVV0p36_NoPreSelRelaxBSPVetodR0p4VetoMissLLPVetoTrkJetByMiniJetHistsOnnormdzUlv30bmpreselhighptv6/mfv_stopbbarbbar_tau'+ctau+'um_M'+mass+'_'+ year +'.root')  
...
ps = plot_saver(plot_dir('TM_Results_June5_2026_stop_bb_highpt_m%s' % mass), size=(700,600), pdf=True, log=False)
canvas = ps.c
