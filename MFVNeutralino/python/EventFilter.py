...
def setup_event_filter(process,
    ...
    if trigger_filter == 'jets only':
        ...
        raise ValueError('trigger_filter %r bad: must be one of ("jets only", "leptons only", "bjets only", "displaced dijet only", "HT OR bjets OR displaced dijet", "bjets OR displaced dijet", "bjets OR displaced dijet veto HT", True, False)' % trigger_filter)
    ...
    if event_filter:
        ...
        print "Here 2: " , event_filter_name
