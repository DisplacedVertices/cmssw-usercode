...
mfvEvent = cms.EDProducer('MFVEventProducer',
                          ...
                          #secondaries_src = cms.InputTag('mfvGenParticles', 'secondaries'),
                          #primaries_src = cms.InputTag('mfvGenParticles', 'primaries'),
                          gen_particles_src = cms.InputTag('genParticles'),
                          mci_src = cms.InputTag('mfvGenParticles'),
                          pileup_info_src = cms.InputTag('addPileupInfo'),
                          jets_src = cms.InputTag('selectedPatJets'),
                          calo_jets_src = cms.InputTag('slimmedCaloJets'),
                          ...
                          vertex_seed_tracks_src = cms.InputTag('mfvVertexTracks', 'seed'),
                          misc_srcs = cms.VInputTag(cms.InputTag('prefiringweight', "nonPrefiringProb", "Ntuple"),
                                                    cms.InputTag('prefiringweight', "nonPrefiringProbUp", "Ntuple"),
                                                    cms.InputTag('prefiringweight', "nonPrefiringProbDown", "Ntuple"),
                                                    ),
