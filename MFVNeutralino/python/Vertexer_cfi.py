...
mfvVertices = cms.EDProducer('MFVVertexer',
                             ...
                             do_track_refinement = cms.bool(False), # track refinement  
                             resolve_split_vertices_loose = cms.bool(False), # Jordan merging 
                             resolve_split_vertices_tight = cms.bool(True), # new merging routine 
                             investigate_merged_vertices = cms.bool(True), # investigate quality cuts on merged vertices  
                             ...
                             merge_anyway_sig = cms.double(4), # resolved split-vertex loose's merging dVV 
                             merge_shared_dist = cms.double(-1),
                             merge_shared_sig = cms.double(4), # default merging dVV  
                             ...
                             trackrefine_sigmacut = cms.double(5), # track refinemnet 
                             trackrefine_trimmax = cms.double(5), # track refinement
                             histos = cms.untracked.bool(True),
