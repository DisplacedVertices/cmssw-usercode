...
mfvVerticesAuxTmp = cms.EDProducer('MFVVertexAuxProducer',
                                   ...
                                   track_gen_require_same_charge = cms.bool(True),
                                   packed_gen_particles_src = cms.InputTag('packedGenParticles'),
                                   pruned_gen_particles_src = cms.InputTag('prunedGenParticles'),
