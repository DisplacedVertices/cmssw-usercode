...
class PileupRemovalPlay : public edm::EDAnalyzer {
 ...
 private:
  ...
  TH1F* h_maxLSPdecay;
  TH2F* h_num_maxLSPdecay;
  TH2F* h_num_withoutLightTrackMatch_maxLSPdecay;
  TH2F* h_num_withLightTrackMatch_maxLSPdecay;
  TH2F* h_ltm_num_descent_1000021_maxLSPdecay;
  TH2F* h_ltm_num_descent_1000022_maxLSPdecay;
  TH2F* h_ltm_num_only_descent_1000021_maxLSPdecay;
    ...
    verbose(cfg.getParameter<bool>("verbose"))
{
  ...
  h_ltm_vz = fs->make<TH1F>("h_ltm_vz", ";vz for pucands with lighttrackmatch;number of pucands", 100, -30, 30);
  ...
  h_ltm_rho_vz = fs->make<TH2F>("h_ltm_rho_vz", ";vz for pucands with lighttrackmatch;rho for pucands with lighttrackmatch", 100, -30, 30, 100, 0, 1);
  h_ltm_rho_vzpvz = fs->make<TH2F>("h_ltm_rho_vzpvz", ";vz - pv_z for pucands with lighttrackmatch;rho for pucands with lighttrackmatch", 100, -30, 30, 100, 0, 1);
  h_ltm_eta_rho = fs->make<TH2F>("h_ltm_eta_rho", ";rho for pucands with lighttrackmatch;eta for pucands with lighttrackmatch", 100, 0, 1, 60, -3, 3);
  h_ltm_eta_vz = fs->make<TH2F>("h_ltm_eta_vz", ";vz for pucands with lighttrackmatch;eta for pucands with lighttrackmatch", 100, -30, 30, 60, -3, 3);
  h_ltm_vzpvz = fs->make<TH1F>("h_ltm_vzpvz", ";vz - pv_z for pucands with lighttrackmatch;number of pucands", 100, -30, 30); 
  ...
  h_noltm_vz = fs->make<TH1F>("h_noltm_vz", ";vz for pucands without lighttrackmatch;number of pucands", 100, -30, 30);
  ...
  h_noltm_rho_vz = fs->make<TH2F>("h_noltm_rho_vz", ";vz for pucands without lighttrackmatch;rho for pucands without lighttrackmatch", 100, -30, 30, 100, 0, 1);
  h_noltm_rho_vzpvz = fs->make<TH2F>("h_noltm_rho_vzpvz", ";vz - pv_z for pucands without lighttrackmatch;rho for pucands without lighttrackmatch", 100, -30, 30, 100, 0, 1);
  h_noltm_eta_rho = fs->make<TH2F>("h_noltm_eta_rho", ";rho for pucands without lighttrackmatch;eta for pucands without lighttrackmatch", 100, 0, 1, 60, -3, 3);
  h_noltm_eta_vz = fs->make<TH2F>("h_noltm_eta_vz", ";vz for pucands without lighttrackmatch;eta for pucands without lighttrackmatch", 100, -30, 30, 60, -3, 3);
  h_noltm_vzpvz = fs->make<TH1F>("h_noltm_vzpvz", ";vz - pv_z for pucands without lighttrakcmatch;number of pucands", 100, -30, 30);
  ...
  h_minLSPdecay = fs->make<TH1F>("h_minLSPdecay", ";min LSP flight distance;events", 20, 0, 1);
  h_num_minLSPdecay = fs->make<TH2F>("h_num_minLSPdecay", ";min LSP flight distance;number of pucands", 20, 0, 1, 100, 0, 2000);
  h_num_withoutLightTrackMatch_minLSPdecay = fs->make<TH2F>("h_num_withoutLightTrackMatch_minLSPdecay", ";min LSP flight distance;number of pucands without lighttrackmatch", 20, 0, 1, 100, 0, 2000);
  h_num_withLightTrackMatch_minLSPdecay = fs->make<TH2F>("h_num_withLightTrackMatch_minLSPdecay", ";min LSP flight distance;number of pucands with lighttrackmatch", 20, 0, 1, 100, 0, 300);
  h_ltm_num_descent_1000021_minLSPdecay = fs->make<TH2F>("h_ltm_num_descent_1000021_minLSPdecay", ";min LSP flight distance;number of pucands where ltm.descent_1000021 is true", 20, 0, 1, 100, 0, 200);
  h_ltm_num_descent_1000022_minLSPdecay = fs->make<TH2F>("h_ltm_num_descent_1000022_minLSPdecay", ";min LSP flight distance;number of pucands where ltm.descent_1000022 is true", 20, 0, 1, 100, 0, 200);
  h_ltm_num_only_descent_1000021_minLSPdecay = fs->make<TH2F>("h_ltm_num_only_descent_1000021_minLSPdecay", ";min LSP flight distance;number of pucands where only ltm.descent_1000021 is true", 20, 0, 1, 100, 0, 200);
  h_avgLSPdecay = fs->make<TH1F>("h_avgLSPdecay", ";avg LSP flight distance;events", 20, 0, 2);
  h_num_avgLSPdecay = fs->make<TH2F>("h_num_avgLSPdecay", ";avg LSP flight distance;number of pucands", 20, 0, 2, 100, 0, 2000);
  h_num_withoutLightTrackMatch_avgLSPdecay = fs->make<TH2F>("h_num_withoutLightTrackMatch_avgLSPdecay", ";avg LSP flight distance;number of pucands without lighttrackmatch", 20, 0, 2, 100, 0, 2000);
  h_num_withLightTrackMatch_avgLSPdecay = fs->make<TH2F>("h_num_withLightTrackMatch_avgLSPdecay", ";avg LSP flight distance;number of pucands with lighttrackmatch", 20, 0, 2, 100, 0, 300);
  h_ltm_num_descent_1000021_avgLSPdecay = fs->make<TH2F>("h_ltm_num_descent_1000021_avgLSPdecay", ";avg LSP flight distance;number of pucands where ltm.descent_1000021 is true", 20, 0, 2, 100, 0, 200);
  h_ltm_num_descent_1000022_avgLSPdecay = fs->make<TH2F>("h_ltm_num_descent_1000022_avgLSPdecay", ";avg LSP flight distance;number of pucands where ltm.descent_1000022 is true", 20, 0, 2, 100, 0, 200);
  h_ltm_num_only_descent_1000021_avgLSPdecay = fs->make<TH2F>("h_ltm_num_only_descent_1000021_avgLSPdecay", ";avg LSP flight distance;number of pucands where only ltm.descent_1000021 is true", 20, 0, 2, 100, 0, 200);
  h_maxLSPdecay = fs->make<TH1F>("h_maxLSPdecay", ";max LSP flight distance;events", 20, 0, 2);
  h_num_maxLSPdecay = fs->make<TH2F>("h_num_maxLSPdecay", ";max LSP flight distance;number of pucands", 20, 0, 2, 100, 0, 2000);
  h_num_withoutLightTrackMatch_maxLSPdecay = fs->make<TH2F>("h_num_withoutLightTrackMatch_maxLSPdecay", ";max LSP flight distance;number of pucands without lighttrackmatch", 20, 0, 2, 100, 0, 2000);
  h_num_withLightTrackMatch_maxLSPdecay = fs->make<TH2F>("h_num_withLightTrackMatch_maxLSPdecay", ";max LSP flight distance;number of pucands with lighttrackmatch", 20, 0, 2, 100, 0, 300);
  h_ltm_num_descent_1000021_maxLSPdecay = fs->make<TH2F>("h_ltm_num_descent_1000021_maxLSPdecay", ";max LSP flight distance;number of pucands where ltm.descent_1000021 is true", 20, 0, 2, 100, 0, 200);
  h_ltm_num_descent_1000022_maxLSPdecay = fs->make<TH2F>("h_ltm_num_descent_1000022_maxLSPdecay", ";max LSP flight distance;number of pucands where ltm.descent_1000022 is true", 20, 0, 2, 100, 0, 200);
  h_ltm_num_only_descent_1000021_maxLSPdecay = fs->make<TH2F>("h_ltm_num_only_descent_1000021_maxLSPdecay", ";max LSP flight distance;number of pucands where only ltm.descent_1000021 is true", 20, 0, 2, 100, 0, 200);
...
void PileupRemovalPlay::analyze(const edm::Event& event, const edm::EventSetup&) {
  ...
  float LSPdecay0 = mag(mci.stranges[0]->vx() - mci.lsps[0]->vx(), mci.stranges[0]->vy() - mci.lsps[0]->vy(), mci.stranges[0]->vz() - mci.lsps[0]->vz());
  float LSPdecay1 = mag(mci.stranges[1]->vx() - mci.lsps[1]->vx(), mci.stranges[1]->vy() - mci.lsps[1]->vy(), mci.stranges[1]->vz() - mci.lsps[1]->vz());
  float minLSPdecay = 0;
  float maxLSPdecay = 0;
  if (LSPdecay0 < LSPdecay1) {
    minLSPdecay = LSPdecay0;
    maxLSPdecay = LSPdecay1;
  } else {
    minLSPdecay = LSPdecay1;
    maxLSPdecay = LSPdecay0;
  }
  ...
  for (const reco::PFCandidate& pucand : *pucands) {
    ...
    if (it == ltmm->end()) {
      ...
      h_noltm_rho_vzpvz->Fill(pucand.vz() - the_pv.z(), drho);
    ...
    h_ltm_rho_vzpvz->Fill(pucand.vz() - the_pv.z(), drho);
  ...
  h_maxLSPdecay->Fill(maxLSPdecay);
  h_num_maxLSPdecay->Fill(maxLSPdecay, num);
  h_num_withoutLightTrackMatch_maxLSPdecay->Fill(maxLSPdecay, num_withoutLightTrackMatch);
  h_num_withLightTrackMatch_maxLSPdecay->Fill(maxLSPdecay, num_withLightTrackMatch);
  h_ltm_num_descent_1000021_maxLSPdecay->Fill(maxLSPdecay, ltm_num_descent_1000021);
  h_ltm_num_descent_1000022_maxLSPdecay->Fill(maxLSPdecay, ltm_num_descent_1000022);
  h_ltm_num_only_descent_1000021_maxLSPdecay->Fill(maxLSPdecay, ltm_num_only_descent_1000021);
