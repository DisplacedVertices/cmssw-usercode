...
class MFVEventHistos : public edm::EDAnalyzer {
 ...
 private:
  ...
  TH1F* h_vertex_seed_track_rescale_err_dxy;
  TH1F* h_vertex_seed_track_err_dz;
  TH1F* h_vertex_seed_track_nsigmadxy;
  TH1F* h_vertex_seed_track_rescale_nsigmadxy;
...

{
  ...
  h_vertex_seed_track_rescale_err_dxy = fs->make<TH1F>("h_vertex_seed_track_rescale_err_dxy", ";vertex seed track rescaled #sigma(dxy) (cm);tracks/3 #mum", 100, 0, 0.03);
  ...
  h_vertex_seed_track_nsigmadxy = fs->make<TH1F>("h_vertex_seed_track_nsigmadxy", ";vertex seed track n#sigma(dxy);tracks/arb. units", 400, -100, 100);
  h_vertex_seed_track_rescale_nsigmadxy = fs->make<TH1F>("h_vertex_seed_track_rescale_nsigmadxy", ";vertex seed track rescaled n#sigma(dxy);tracks/arb. units", 400, -100, 100);
...
void MFVEventHistos::analyze(const edm::Event& event, const edm::EventSetup&) {
 ...
 const size_t ngenele = mevent->gen_electrons.size();
  ...
  for (size_t i = 0; i < n_vertex_seed_tracks; ++i) {
    ...
    h_vertex_seed_track_rescale_err_dxy->Fill(mevent->vertex_seed_track_rescale_err_dxy[i], w);
    h_vertex_seed_track_err_dz->Fill(mevent->vertex_seed_track_err_dz[i], w);
    h_vertex_seed_track_nsigmadxy->Fill(mevent->vertex_seed_track_dxy[i]/mevent->vertex_seed_track_err_dxy[i], w);
    h_vertex_seed_track_rescale_nsigmadxy->Fill(mevent->vertex_seed_track_dxy[i]/mevent->vertex_seed_track_rescale_err_dxy[i], w);
