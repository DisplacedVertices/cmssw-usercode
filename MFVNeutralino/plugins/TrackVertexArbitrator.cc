...
class MFVTrackVertexArbitrator : public edm::EDProducer {
    public:
	MFVTrackVertexArbitrator(const edm::ParameterSet &params);
...
MFVTrackVertexArbitrator::MFVTrackVertexArbitrator(const edm::ParameterSet &params) :
...
void MFVTrackVertexArbitrator::produce(edm::Event &event, const edm::EventSetup &es)
{
