    ...
    track_vertex_weight_min(cfg.getParameter<double>("track_vertex_weight_min"))
{
  ...
  hs.add("njetsmissdist",  "# of jets assoc. by miss distance to SV",     10,    0,      10);
  hs.add("njetscomb",      "# of jets assoc. by combination to SV",       10,    0,      10);
  hs.add("njetscombptmin", "# of jets assoc. by comb. (min pT) to SV",    10,    0,      10);
  hs.add("jetsmassntks",   "inv. mass of jets assoc. by tracks to SV",   200,    0,    2000);
  hs.add("jetsmassntksptmin", "inv. mass of jets assoc. by tracks (min pT) to SV",   200,    0,    2000);
