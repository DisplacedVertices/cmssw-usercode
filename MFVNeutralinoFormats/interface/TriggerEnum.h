...
namespace mfv {
  ...
  enum {
	b_HLT_PFHT1050, 
    b_HLT_Ele27_WPTight_Gsf, b_HLT_Ele32_WPTight_Gsf, b_HLT_Ele35_WPTight_Gsf, b_HLT_Ele115_CaloIdVT_GsfTrkIdT, b_HLT_Ele50_CaloIdVT_GsfTrkIdT_PFJet165, b_HLT_IsoMu27, b_HLT_Mu50, // Single Lepton triggers
  ...
  static const std::vector<size_t> LeptonTriggers = {
    //lepton triggers
    mfv::b_HLT_Ele32_WPTight_Gsf, mfv::b_HLT_IsoMu27, mfv::b_HLT_Mu50,
    mfv::b_HLT_Ele115_CaloIdVT_GsfTrkIdT, mfv::b_HLT_Ele50_CaloIdVT_GsfTrkIdT_PFJet165,
  };
