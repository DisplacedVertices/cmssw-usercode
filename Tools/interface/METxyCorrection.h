#ifndef JMTucker_Tools_METxyCorrection_h
#define JMTucker_Tools_METxyCorrection_h
...
namespace jmt{
  ...
  std::pair<double,double> METXYCorr_Met_MetPhi(double originalMet, double originalMet_phi, int runnb, int year, bool isMC, int npv, bool isUL =true,bool ispuppi=false){
    ...
    //std::cout << "METxcorr " << METxcorr << std::endl;
    //std::cout << "METycorr " << METycorr << std::endl;
    double CorrectedMET_x = originalMet *std::cos( originalMet_phi)+METxcorr;
    double CorrectedMET_y = originalMet *std::sin( originalMet_phi)+METycorr;
    //std::cout << "CorrectedMET_x " << CorrectedMET_x << " CorrectedMET_y " << CorrectedMET_y << std::endl;
  
    double CorrectedMET = std::sqrt(CorrectedMET_x*CorrectedMET_x+CorrectedMET_y*CorrectedMET_y);
