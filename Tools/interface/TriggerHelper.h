...
struct TriggerHelper {
    ...
    bool pass(const char* fmt, int range_lo, int range_hi, bool throw_not_found=false) const {
        char name[512];
    ...
    bool pass_any_version(const std::string& trigger, bool throw_not_found=false) const {
