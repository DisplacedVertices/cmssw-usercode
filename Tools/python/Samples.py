...
span_signal_samples_2017 = [eval('mfv_stopdbardbar_tau%06ium_M%04i_2017' % (b,c)) for b in (1000,10000) for c in (400,800)]
...
########
# ntuples
for x in mfv_stopdbardbar_tau010000um_M0800_2017, ggHToSSTodddd_tau1mm_M55_2017:
