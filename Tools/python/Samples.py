...
bjet_samples_2017 = [
    ...
    MCSample('qcdht0200_2017', '/QCD_HT200to300_TuneCP5_13TeV-madgraph-pythia8/RunIIFall17DRPremix-PU2017_94X_mc2017_realistic_v11-v1/AODSIM', 59427619, nice='QCD, 200 < H_{T} < 300 GeV',  color=805, syst_frac=0.20, xsec=1.546e6),
    ...
    MCSample('ggHbb_2017',      '/GluGluHToBB_M-125_13TeV_powheg_MINLO_NNLOPS_pythia8/RunIIFall17DRPremix-PU2017_94X_mc2017_realistic_v11-v1/AODSIM',             9986100, nice='ggHbb', color=1, syst_frac=0.20, xsec=27.8),
    MCSample('zz_2017',       '/ZZ_TuneCP5_13TeV-pythia8/RunIIFall17DRPremix-94X_mc2017_realistic_v10-v1/AODSIM',                               1949768, nice='zz',  color=1, syst_frac=0.20, xsec=16.5),
    MCSample('wz_2017',       '/WZ_TuneCP5_13TeV-pythia8/RunIIFall17DRPremix-94X_mc2017_realistic_v10-v1/AODSIM',                               3928630, nice='wz',  color=1, syst_frac=0.20, xsec=47.1),
    MCSample('ww_2017',       '/WW_TuneCP5_13TeV-pythia8/RunIIFall17DRPremix-94X_mc2017_realistic_v10-v1/AODSIM',                               7791498, nice='ww',  color=1, syst_frac=0.20, xsec=118.7),
    ]
...
mfv_signal_samples_2017 = [
    ...
    MCSample('mfv_neu_tau001000um_M0400_2017', '/GluinoGluinoToNeutralinoNeutralinoTo2T2B2S_M-400_CTau-1mm_TuneCP2_13TeV-pythia8/RunIIFall17MiniAODv2-PU2017_12Apr2018_94X_mc2017_realistic_v14-v1/MINIAODSIM', 100000), #'/GluinoGluinoToNeutralinoNeutralinoTo2T2B2S_M-400_CTau-1mm_TuneCP2_13TeV-pythia8/RunIIFall17DRPremix-PU2017_94X_mc2017_realistic_v11-v1/AODSIM', 100000),
    ...
    MCSample('mfv_neu_tau010000um_M0400_2017', '/GluinoGluinoToNeutralinoNeutralinoTo2T2B2S_M-400_CTau-10mm_TuneCP2_13TeV-pythia8/RunIIFall17MiniAODv2-PU2017_12Apr2018_94X_mc2017_realistic_v14-v1/MINIAODSIM', 100000), #'/GluinoGluinoToNeutralinoNeutralinoTo2T2B2S_M-400_CTau-10mm_TuneCP2_13TeV-pythia8/RunIIFall17DRPremix-PU2017_94X_mc2017_realistic_v11-v1/AODSIM', 100000),
...
mfv_stopdbardbar_samples_2017 = [
    ...
    MCSample('mfv_stopdbardbar_tau001000um_M0400_2017', '/StopStopbarTo2Dbar2D_M-400_CTau-1mm_TuneCP2_13TeV-pythia8/RunIIFall17MiniAODv2-PU2017_12Apr2018_94X_mc2017_realistic_v14-v1/MINIAODSIM', 100000),#'/StopStopbarTo2Dbar2D_M-400_CTau-1mm_TuneCP2_13TeV-pythia8/RunIIFall17DRPremix-PU2017_94X_mc2017_realistic_v11-v1/AODSIM', 100000),
    ...
    MCSample('mfv_stopdbardbar_tau010000um_M0400_2017', '/StopStopbarTo2Dbar2D_M-400_CTau-10mm_TuneCP2_13TeV-pythia8/RunIIFall17MiniAODv2-PU2017_12Apr2018_94X_mc2017_realistic_v14-v1/MINIAODSIM', 100000), #'/StopStopbarTo2Dbar2D_M-400_CTau-10mm_TuneCP2_13TeV-pythia8/RunIIFall17DRPremix-PU2017_94X_mc2017_realistic_v11-v1/AODSIM', 100000),
...
goofin_2017 = [
    MCSample('EmJets_MX1000_Mdpi1_tau1mm_2017', '/EmergingJets_mX-1000-m_dpi-1-ctau_dpi-1_TuneCP5_13TeV_pythia8/RunIIFall17DRPremix-PU2017_94X_mc2017_realistic_v11-v1/AODSIM', 100000),
    MCSample('EmJets_MX1000_Mdpi2_tau5mm_2017', '/EmergingJets_mX-1000-m_dpi-2-ctau_dpi-5_TuneCP5_13TeV_pythia8/RunIIFall17DRPremix-PU2017_94X_mc2017_realistic_v11-v1/AODSIM', 100000),
]
...
#qcdht0200_2017.add_dataset('miniaod', '/QCD_HT200to300_TuneCP5_13TeV-madgraph-pythia8/RunIIFall17MiniAODv2-PU2017_12Apr2018_new_pmx_94X_mc2017_realistic_v14-v2/MINIAODSIM',   59427619)
...
ggHbb_2017.add_dataset('miniaod', '/GluGluHToBB_M-125_13TeV_powheg_MINLO_NNLOPS_pythia8/RunIIFall17MiniAODv2-PU2017_12Apr2018_94X_mc2017_realistic_v14-v1/MINIAODSIM', 9986100)
zz_2017.add_dataset('miniaod', '/ZZ_TuneCP5_13TeV-pythia8/RunIIFall17MiniAODv2-PU2017_12Apr2018_94X_mc2017_realistic_v14-v1/MINIAODSIM', 1949768)
wz_2017.add_dataset('miniaod', '/WZ_TuneCP5_13TeV-pythia8/RunIIFall17MiniAODv2-PU2017_12Apr2018_94X_mc2017_realistic_v14-v1/MINIAODSIM', 3928630)
ww_2017.add_dataset('miniaod', '/WW_TuneCP5_13TeV-pythia8/RunIIFall17MiniAODv2-PU2017_12Apr2018_94X_mc2017_realistic_v14-v1/MINIAODSIM', 7791498)
...
#_adbp('miniaod', '/EmergingJets_mX-1000-m_dpi-1-ctau_dpi-1_TuneCP5_13TeV_pythia8/RunIIFall17MiniAODv2-PU2017_12Apr2018_94X_mc2017_realistic_v14-v1/MINIAODSIM', 100000)
EmJets_MX1000_Mdpi1_tau1mm_2017.add_dataset('miniaod', '/EmergingJets_mX-1000-m_dpi-1-ctau_dpi-1_TuneCP5_13TeV_pythia8/RunIIFall17MiniAODv2-PU2017_12Apr2018_94X_mc2017_realistic_v14-v1/MINIAODSIM', 100000)
EmJets_MX1000_Mdpi2_tau5mm_2017.add_dataset('miniaod', '/EmergingJets_mX-1000-m_dpi-2-ctau_dpi-5_TuneCP5_13TeV_pythia8/RunIIFall17MiniAODv2-PU2017_12Apr2018_94X_mc2017_realistic_v14-v1/MINIAODSIM', 100000)
...
########
# ntuples
#ggHToSSTodddd_tau1mm_M55_2017.add_dataset('ntuplegvtxbjettrknsigma4v27am', '/ggH_HToSSTodddd_MH-125_MS-55_ctauS-1_pT75_TuneCP5_13TeV-powheg-pythia8/pekotamn-NtupleGvtxBjetTrknSigma4V27Am_NoEF_2017-f5bdd435ed37cd686ad53a56065bdd67/USER', -1) 
#ggHToSSTodddd_tau1mm_M55_2017.add_dataset('ntuplegvtxbjettrknsigma2v27am', '/ggH_HToSSTodddd_MH-125_MS-55_ctauS-1_pT75_TuneCP5_13TeV-powheg-pythia8/pekotamn-NtupleGvtxBjetTrknSigma2V27Am_NoEF_2017-b3c86354f71e29141ba5a02a42c4a983/USER', 127636)
#ggHToSSTodddd_tau1mm_M55_2017.add_dataset('ntuplegvtxbjettrknsigma4v28am', '/ggH_HToSSTodddd_MH-125_MS-55_ctauS-1_pT75_TuneCP5_13TeV-powheg-pythia8/pekotamn-NtupleGvtxBjetTrknSigma4V28Am_NoEF_2017-41eb1afec8c7b78cd1d252b0f241bdb2/USER', 164465)
#ggHToSSTodddd_tau1mm_M55_2017.add_dataset('ntuplegvtxbjettrknsigma2v28am', '/ggH_HToSSTodddd_MH-125_MS-55_ctauS-1_pT75_TuneCP5_13TeV-powheg-pythia8/pekotamn-NtupleGvtxBjetTrknSigma2V28Am_NoEF_2017-7f93d3bc0489fbdf05017ba36ad2bf1d/USER', 127636)
#ggHToSSTodddd_tau1mm_M55_2017.add_dataset('ntuplegvtxbjettrknsigma4v29am', '/ggH_HToSSTodddd_MH-125_MS-55_ctauS-1_pT75_TuneCP5_13TeV-powheg-pythia8/pekotamn-NtupleGvtxBjetTrknSigma4V29Am_NoEF_2017-839d7a94a14a6b1beb78aab67d9dbdde/USER', 164465) 
ggHToSSTodddd_tau1mm_M55_2017.add_dataset('ntuplegvtxbjettrknsigma2v29am', '/ggH_HToSSTodddd_MH-125_MS-55_ctauS-1_pT75_TuneCP5_13TeV-powheg-pythia8/pekotamn-NtupleGvtxBjetTrknSigma2V29Am_NoEF_2017-b5fe759934603ce661faaa4bcc0bba3a/USER', 127636)
for x in mfv_neu_tau001000um_M0400_2017, mfv_stopdbardbar_tau001000um_M0400_2017, mfv_stopdbardbar_tau010000um_M0400_2017, ggHToSSTodddd_tau10mm_M55_2017:
    x.add_dataset("ntuplegvtxbjettrknsigma2v29am")

#ggHToSSTodddd_tau1mm_M55_2017.add_dataset('ntuplegvtxbjettrknsigma2nchi8v27am', '/ggH_HToSSTodddd_MH-125_MS-55_ctauS-1_pT75_TuneCP5_13TeV-powheg-pythia8/pekotamn-NtupleGvtxBjetTrknSigma2nChi8V27Am_NoEF_2017-1542361fe2374313de0a3794255fb3cf/USER', 127636)

ttbar_2017.add_dataset('ntuplegvtxbjettrknsigma2v29am', '/TTJets_TuneCP5_13TeV-amcatnloFXFX-pythia8/pekotamn-NtupleGvtxBjetTrknSigma2V29Am_2017-176113187681eef4dde31ba940979508/USER', 2473896)
singletop_tchan_top_2017.add_dataset('ntuplegvtxbjettrknsigma2v29am', '/ST_t-channel_top_4f_inclusiveDecays_TuneCP5_13TeV-powhegV2-madspin-pythia8/pekotamn-NtupleGvtxBjetTrknSigma2V29Am_2017-f83138e15ccdf5fc2066a77f6ec193fd/USER', 8567)
singletop_tchan_antitop_2017.add_dataset('ntuplegvtxbjettrknsigma2v29am', '/ST_t-channel_antitop_4f_inclusiveDecays_TuneCP5_13TeV-powhegV2-madspin-pythia8/pekotamn-NtupleGvtxBjetTrknSigma2V29Am_2017-3344a30c749e08623a3181b7d763fc66/USER', 5148)
for x in qcdht1000_2017, qcdht1500_2017, qcdht2000_2017, ttbarht0600_2017, ttbarht0800_2017, ttbarht1200_2017, ttbarht2500_2017, qcdht0200_2017:
    x.add_dataset("ntuplegvtxbjettrknsigma2v29am")
"""
ttbar_2017.add_dataset('ntuplegvtxbjettrknsigma4v29am', '/TTJets_TuneCP5_13TeV-amcatnloFXFX-pythia8/pekotamn-NtupleGvtxBjetTrknSigma4V29Am_2017-2468ef9944f664e191245bad6dbdf82c/USER', 769873)
singletop_tchan_top_2017.add_dataset('ntuplegvtxbjettrknsigma4v29am', '/ST_t-channel_top_4f_inclusiveDecays_TuneCP5_13TeV-powhegV2-madspin-pythia8/pekotamn-NtupleGvtxBjetTrknSigma4V29Am_2017-06cea22174198ee72afd04adf25ce0d3/USER', 2743)
singletop_tchan_antitop_2017.add_dataset('ntuplegvtxbjettrknsigma4v29am', '/ST_t-channel_antitop_4f_inclusiveDecays_TuneCP5_13TeV-powhegV2-madspin-pythia8/pekotamn-NtupleGvtxBjetTrknSigma4V29Am_2017-9eda17c47b64944e6e2c8f09a68d83ca/USER', 1734)
for x in qcdht1000_2017, qcdht1500_2017, qcdht2000_2017, ttbarht0600_2017, ttbarht0800_2017, ttbarht1200_2017, ttbarht2500_2017, qcdht0200_2017:
    x.add_dataset("ntuplegvtxbjettrknsigma4v29am")
"""

#qcdht2000_2017.add_dataset("ntuplenochi2gvtxbjettrknsigma4v29am")
########
...
for x in HToSSTodddd_samples_2017:
    x.add_dataset("ntuplev31am")
...
condorable = {
    ...
    "T2_US_Nebraska": {
        ...
        "miniaod": [SingleMuon2017C, qcdht0300_2017, mfv_neu_tau030000um_M1600_2017, ggHToSSTodddd_tau10mm_M40_2017], #ggHToSSTodddd_tau1000mm_M55_2017, ggHToSSTodddd_tau100mm_M55_2017],
        },
    "T2_US_Purdue": {
    ...
    "T2_US_Wisconsin" : {
        "miniaod": [ttZ_2017, mfv_stopdbardbar_tau000300um_M0600_2017, EmJets_MX1000_Mdpi2_tau5mm_2017,] #ggHToSSTobbbb_tau10mm_M55_2017]
        },
    }
...
if __name__ == '__main__':
    ...
    if 1:
        #for s in all_signal_samples_2017 + all_signal_samples_2018 + bjet_samples_2017:
        for s in bjet_samples_2017 + goofin_2017:
    ...
    if 1:
        #for s in qcd_samples_2017 + ttbar_samples_2017 + qcd_samples_2018 + ttbar_samples_2018 + bjet_samples_2017:
        for s in goofin_2017:
