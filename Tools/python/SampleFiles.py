...
_add_ds("trackmoveroffdzulv30lepmumv4", {
'qcdmupt15_2017': (1, ['/store/group/lpclonglived/pkotamni/QCD_Pt-20_MuEnrichedPt15_TuneCP5_13TeV-pythia8/TrackMoverOffdzULV30LepMumv4_2017/240111_085038/0000/movedtree_0.root']),
'qcdpt15mupt5_2017': (31, ['/store/group/lpclonglived/pkotamni/QCD_Pt-15To20_MuEnrichedPt5_TuneCP5_13TeV-pythia8/TrackMoverOffdzULV30LepMumv4_2017/240110_190754/0000/movedtree_%i.root' % i for i in chain(xrange(6), xrange(7,9), xrange(10,13), xrange(14,21), xrange(22,26), xrange(29,31), [27])] + ['/store/group/lpclonglived/pkotamni/QCD_Pt-15To20_MuEnrichedPt5_TuneCP5_13TeV-pythia8/TrackMoverOffdzULV30LepMumv4_2017/240111_085037/0000/movedtree_%i.root' % i for i in [6, 9, 13, 21, 26, 28]]),
'qcdpt20mupt5_2017': (214, ['/store/group/lpclonglived/pkotamni/QCD_Pt-20To30_MuEnrichedPt5_TuneCP5_13TeV-pythia8/TrackMoverOffdzULV30LepMumv4_2017/240111_085039/0000/movedtree_%i.root' % i for i in chain(xrange(23,25), xrange(30,32), xrange(50,52), xrange(102,104), xrange(178,180), [1, 10, 16, 36, 39, 54, 56, 60, 66, 69, 73, 79, 84, 87, 90, 94, 100, 137, 141, 157, 162, 173, 182, 184, 203])] + ['/store/group/lpclonglived/pkotamni/QCD_Pt-20To30_MuEnrichedPt5_TuneCP5_13TeV-pythia8/TrackMoverOffdzULV30LepMumv4_2017/240110_190755/0000/movedtree_%i.root' % i for i in chain(xrange(2,10), xrange(11,16), xrange(17,23), xrange(25,30), xrange(32,36), xrange(37,39), xrange(40,50), xrange(52,54), xrange(57,60), xrange(61,66), xrange(67,69), xrange(70,73), xrange(74,79), xrange(80,84), xrange(85,87), xrange(88,90), xrange(91,94), xrange(95,100), xrange(104,137), xrange(138,141), xrange(142,157), xrange(158,162), xrange(163,173), xrange(174,178), xrange(180,182), xrange(185,203), xrange(204,214), [0, 55, 101, 183])]),
'qcdpt30mupt5_2017': (354, ['/store/group/lpclonglived/pkotamni/QCD_Pt-30To50_MuEnrichedPt5_TuneCP5_13TeV-pythia8/TrackMoverOffdzULV30LepMumv4_2017/240110_190756/0000/movedtree_%i.root' % i for i in chain(xrange(37), xrange(38,67), xrange(68,161), xrange(162,201), xrange(202,204), xrange(205,277), xrange(278,287), xrange(288,305), xrange(306,357))] + ['/store/group/lpclonglived/pkotamni/QCD_Pt-30To50_MuEnrichedPt5_TuneCP5_13TeV-pythia8/TrackMoverOffdzULV30LepMumv4_2017/240111_085032/0000/movedtree_%i.root' % i for i in [67, 201, 204, 277, 287]]),
'qcdpt80mupt5_2017': (215, ['/store/group/lpclonglived/pkotamni/QCD_Pt-80To120_MuEnrichedPt5_TuneCP5_13TeV-pythia8/TrackMoverOffdzULV30LepMumv4_2017/240110_190851/0000/movedtree_%i.root' % i for i in chain(xrange(2,15), xrange(20,27), xrange(28,30), xrange(31,41), xrange(42,48), xrange(52,56), xrange(57,61), xrange(64,71), xrange(80,85), xrange(87,89), xrange(96,102), xrange(104,106), xrange(107,109), xrange(110,112), xrange(114,123), xrange(124,132), xrange(133,137), xrange(139,149), xrange(152,156), xrange(157,165), xrange(173,175), xrange(176,183), xrange(184,188), xrange(190,202), xrange(205,212), xrange(213,220), xrange(221,224), xrange(225,230), xrange(231,235), xrange(237,239), xrange(241,248), xrange(249,258), xrange(260,262), xrange(267,274), [0, 16, 18, 49, 62, 72, 74, 77, 93, 150, 167, 169, 203, 263, 265, 276])] + ['/store/group/lpclonglived/pkotamni/QCD_Pt-80To120_MuEnrichedPt5_TuneCP5_13TeV-pythia8/TrackMoverOffdzULV30LepMumv4_2017/240111_085019/0000/movedtree_%i.root' % i for i in [1, 17, 41, 94, 183, 275]]),
'qcdpt120mupt5_2017': (112, ['/store/group/lpclonglived/pkotamni/QCD_Pt-120To170_MuEnrichedPt5_TuneCP5_13TeV-pythia8/TrackMoverOffdzULV30LepMumv4_2017/240110_190852/0000/movedtree_%i.root' % i for i in chain(xrange(4,6), xrange(30,32), xrange(42,46), xrange(50,56), xrange(58,61), xrange(72,74), xrange(76,82), xrange(85,87), xrange(101,104), xrange(116,121), xrange(122,125), xrange(128,132), xrange(138,141), xrange(158,161), xrange(186,191), xrange(192,194), xrange(195,198), xrange(199,201), xrange(212,214), xrange(217,219), xrange(221,223), xrange(225,227), xrange(230,232), xrange(240,244), [2, 8, 12, 14, 18, 21, 24, 28, 33, 40, 48, 63, 68, 90, 92, 95, 97, 108, 111, 113, 126, 134, 147, 153, 163, 166, 169, 172, 177, 182, 184, 202, 204, 206, 210, 228, 235, 237])]),
'qcdpt170mupt5_2017': (82, ['/store/group/lpclonglived/pkotamni/QCD_Pt-170To300_MuEnrichedPt5_TuneCP5_13TeV-pythia8/TrackMoverOffdzULV30LepMumv4_2017/240110_190853/0000/movedtree_%i.root' % i for i in chain(xrange(18,20), xrange(43,45), xrange(46,48), xrange(53,55), xrange(80,83), xrange(119,122), xrange(132,134), xrange(218,220), xrange(239,241), xrange(348,350), xrange(372,374), xrange(389,391), xrange(405,407), xrange(435,437), [2, 11, 25, 30, 65, 71, 75, 89, 92, 96, 103, 109, 111, 117, 128, 130, 135, 140, 144, 150, 154, 165, 181, 185, 195, 197, 204, 223, 258, 263, 276, 278, 293, 298, 311, 313, 318, 321, 329, 351, 356, 363, 380, 387, 403, 410, 413, 419, 430, 439, 443, 446])]),
'qcdpt300mupt5_2017': (7, ['/store/group/lpclonglived/pkotamni/QCD_Pt-300To470_MuEnrichedPt5_TuneCP5_13TeV-pythia8/TrackMoverOffdzULV30LepMumv4_2017/240110_190854/0000/movedtree_%i.root' % i for i in [52, 57, 98, 114, 180, 204, 274]]),
'qcdpt470mupt5_2017': (1, ['/store/group/lpclonglived/pkotamni/QCD_Pt-470To600_MuEnrichedPt5_TuneCP5_13TeV-pythia8/TrackMoverOffdzULV30LepMumv4_2017/240110_190855/0000/movedtree_143.root']),
'qcdpt600mupt5_2017': (1, ['/store/group/lpclonglived/pkotamni/QCD_Pt-600To800_MuEnrichedPt5_TuneCP5_13TeV-pythia8/TrackMoverOffdzULV30LepMumv4_2017/240110_190856/0000/movedtree_41.root']),
'qcdempt015_2017': (38, ['/store/group/lpclonglived/pkotamni/QCD_Pt-15to20_EMEnriched_TuneCP5_13TeV-pythia8/TrackMoverOffdzULV30LepMumv4_2017/240110_190859/0000/movedtree_%i.root' % i for i in chain(xrange(4), xrange(5,35), xrange(38,41), [36])]),
'qcdempt020_2017': (96, ['/store/group/lpclonglived/pkotamni/QCD_Pt-20to30_EMEnriched_TuneCP5_13TeV-pythia8/TrackMoverOffdzULV30LepMumv4_2017/240111_085053/0000/movedtree_%i.root' % i for i in chain(xrange(38,40), xrange(50,52), xrange(61,63), [0, 25, 44, 78, 87])] + ['/store/group/lpclonglived/pkotamni/QCD_Pt-20to30_EMEnriched_TuneCP5_13TeV-pythia8/TrackMoverOffdzULV30LepMumv4_2017/240110_190900/0000/movedtree_%i.root' % i for i in chain(xrange(1,25), xrange(26,38), xrange(40,44), xrange(45,50), xrange(52,61), xrange(63,78), xrange(79,87), xrange(88,96))]),
'qcdempt030_2017': (4, ['/store/group/lpclonglived/pkotamni/QCD_Pt-30to50_EMEnriched_TuneCP5_13TeV-pythia8/TrackMoverOffdzULV30LepMumv4_2017/240110_190901/0000/movedtree_%i.root' % i for i in chain(xrange(14,17), [31])]),
'qcdempt080_2017': (3, ['/store/group/lpclonglived/pkotamni/QCD_Pt-80to120_EMEnriched_TuneCP5_13TeV-pythia8/TrackMoverOffdzULV30LepMumv4_2017/240110_190903/0000/movedtree_%i.root' % i for i in chain(xrange(34,36), [67])]),
'qcdempt120_2017': (68, ['/store/group/lpclonglived/pkotamni/QCD_Pt-120to170_EMEnriched_TuneCP5_13TeV-pythia8/TrackMoverOffdzULV30LepMumv4_2017/240111_085043/0000/movedtree_%i.root' % i for i in chain(xrange(11,13), xrange(19,22), xrange(44,46), xrange(63,65), xrange(75,78), [5, 7, 30, 52, 67, 71])] + ['/store/group/lpclonglived/pkotamni/QCD_Pt-120to170_EMEnriched_TuneCP5_13TeV-pythia8/TrackMoverOffdzULV30LepMumv4_2017/240110_190904/0000/movedtree_%i.root' % i for i in chain(xrange(3,5), xrange(8,11), xrange(24,27), xrange(28,30), xrange(31,38), xrange(39,44), xrange(46,52), xrange(60,62), xrange(68,71), xrange(78,85), [0, 6, 16, 18, 22, 53, 56, 65, 72, 74])]),
'qcdempt300_2017': _fromnum0("/store/group/lpclonglived/pkotamni/QCD_Pt-300toInf_EMEnriched_TuneCP5_13TeV-pythia8/TrackMoverOffdzULV30LepMumv4_2017/240110_190906", 19, fnbase="movedtree"),
'qcdbctoept020_2017': _fromnum0("/store/group/lpclonglived/pkotamni/QCD_Pt_20to30_bcToE_TuneCP5_13TeV_pythia8/TrackMoverOffdzULV30LepMumv4_2017/240110_190907", 89, fnbase="movedtree"),
'qcdbctoept030_2017': _fromnum0("/store/group/lpclonglived/pkotamni/QCD_Pt_30to80_bcToE_TuneCP5_13TeV_pythia8/TrackMoverOffdzULV30LepMumv4_2017/240110_190908", 87, fnbase="movedtree"),
'qcdbctoept080_2017': (7, ['/store/group/lpclonglived/pkotamni/QCD_Pt_80to170_bcToE_TuneCP5_13TeV_pythia8/TrackMoverOffdzULV30LepMumv4_2017/240110_190909/0000/movedtree_%i.root' % i for i in chain(xrange(79,81), [4, 6, 67, 76])] + ['/store/group/lpclonglived/pkotamni/QCD_Pt_80to170_bcToE_TuneCP5_13TeV_pythia8/TrackMoverOffdzULV30LepMumv4_2017/240111_085016/0000/movedtree_78.root']),
'qcdbctoept250_2017': (21, ['/store/group/lpclonglived/pkotamni/QCD_Pt_250toInf_bcToE_TuneCP5_13TeV_pythia8/TrackMoverOffdzULV30LepMumv4_2017/240110_190911/0000/movedtree_%i.root' % i for i in chain(xrange(1,3), xrange(13,15), xrange(32,34), xrange(49,51), xrange(64,67), xrange(70,72), [23, 30, 36, 41, 45, 54, 56, 59])]),
'wjetstolnu_2017': (168, ['/store/group/lpclonglived/pkotamni/WJetsToLNu_TuneCP5_13TeV-madgraphMLM-pythia8/TrackMoverOffdzULV30LepMumv4_2017/240110_190912/0000/movedtree_%i.root' % i for i in chain(xrange(3,6), xrange(7,9), xrange(15,17), xrange(20,24), xrange(27,29), xrange(34,36), xrange(40,46), xrange(82,84), xrange(104,107), xrange(117,119), xrange(123,125), xrange(138,140), xrange(144,148), xrange(156,159), xrange(163,166), xrange(179,181), xrange(184,186), xrange(244,246), xrange(252,254), xrange(275,277), xrange(287,290), xrange(294,296), xrange(297,299), xrange(329,331), xrange(369,371), xrange(372,374), xrange(375,377), xrange(378,380), xrange(385,387), xrange(388,390), xrange(393,395), xrange(396,399), [12, 30, 32, 37, 52, 60, 63, 65, 93, 96, 98, 109, 112, 120, 128, 131, 135, 149, 152, 154, 171, 176, 190, 193, 196, 198, 201, 203, 205, 210, 215, 229, 238, 241, 247, 255, 260, 262, 266, 268, 270, 272, 278, 280, 307, 309, 316, 319, 323, 325, 335, 344, 346, 356, 359, 361, 364, 366, 383])] + ['/store/group/lpclonglived/pkotamni/WJetsToLNu_TuneCP5_13TeV-madgraphMLM-pythia8/TrackMoverOffdzULV30LepMumv4_2017/240111_085006/0000/movedtree_%i.root' % i for i in chain(xrange(224,226), xrange(258,260), xrange(263,265), xrange(327,329), xrange(332,334), xrange(336,339), xrange(350,354), [36, 38, 143, 166, 207, 233, 242, 250, 267, 284, 312, 322, 341, 377])]),
'wjetstolnu_amcatnlo_2017': (40, ['/store/group/lpclonglived/pkotamni/WJetsToLNu_TuneCP5_13TeV-amcatnloFXFX-pythia8/TrackMoverOffdzULV30LepMumv4_2017/240110_190913/0000/movedtree_%i.root' % i for i in chain(xrange(49,51), xrange(55,57), xrange(63,65), xrange(98,100), xrange(137,139), xrange(141,143), xrange(147,149), [0, 4, 11, 18, 34, 46, 58, 69, 74, 77, 80, 95, 105, 107, 112, 119, 122, 124, 127, 130, 133, 145])] + ['/store/group/lpclonglived/pkotamni/WJetsToLNu_TuneCP5_13TeV-amcatnloFXFX-pythia8/TrackMoverOffdzULV30LepMumv4_2017/240111_085056/0000/movedtree_%i.root' % i for i in [23, 79, 108, 143]]),
'wjetstolnu_0j_2017': (560, ['/store/group/lpclonglived/pkotamni/WJetsToLNu_0J_TuneCP5_13TeV-amcatnloFXFX-pythia8/TrackMoverOffdzULV30LepMumv4_2017/240111_085105/0000/movedtree_%i.root' % i for i in chain(xrange(304,306), xrange(331,338), xrange(364,368), xrange(369,372), xrange(401,403), xrange(407,411), xrange(425,427), xrange(437,439), xrange(440,443), xrange(451,457), xrange(463,468), xrange(469,471), xrange(473,475), xrange(476,481), xrange(488,490), xrange(491,493), xrange(494,499), xrange(552,554), xrange(561,564), xrange(573,575), xrange(580,582), xrange(583,588), xrange(589,591), xrange(592,595), xrange(611,615), xrange(616,620), xrange(621,630), xrange(631,634), xrange(667,669), xrange(671,675), xrange(676,678), xrange(682,686), [55, 75, 102, 106, 111, 227, 294, 298, 300, 302, 311, 352, 359, 384, 389, 405, 448, 459, 485, 506, 549, 576, 596, 598, 602, 604, 608, 636, 639, 645, 654, 658, 660, 662, 665, 680])] + ['/store/group/lpclonglived/pkotamni/WJetsToLNu_0J_TuneCP5_13TeV-amcatnloFXFX-pythia8/TrackMoverOffdzULV30LepMumv4_2017/240110_165215/0000/movedtree_%i.root' % i for i in chain(xrange(2), xrange(3,6), xrange(7,26), xrange(28,33), xrange(34,36), xrange(37,43), xrange(44,55), xrange(56,58), xrange(59,64), xrange(65,70), xrange(71,74), xrange(77,94), xrange(95,101), xrange(103,105), xrange(112,127), xrange(128,138), xrange(139,147), xrange(149,158), xrange(160,164), xrange(166,175), xrange(179,184), xrange(187,189), xrange(191,196), xrange(197,215), xrange(216,227), xrange(228,240), xrange(241,247), xrange(248,252), xrange(253,256), xrange(258,261), xrange(264,266), xrange(267,271), xrange(274,278), xrange(280,284), xrange(286,294), xrange(295,297), xrange(313,315), xrange(316,326), xrange(327,331), xrange(339,341), xrange(342,349), xrange(350,352), xrange(354,357), xrange(361,364), xrange(372,374), xrange(379,384), xrange(385,389), xrange(390,393), xrange(394,398), xrange(399,401), xrange(411,425), xrange(428,430), xrange(433,435), xrange(443,448), xrange(457,459), xrange(482,484), xrange(500,504), xrange(507,509), xrange(511,515), xrange(518,522), xrange(523,549), xrange(558,560), xrange(566,569), xrange(570,572), xrange(634,636), xrange(637,639), xrange(640,642), xrange(643,645), xrange(646,651), xrange(655,658), xrange(663,665), [107, 109, 272, 299, 301, 308, 310, 358, 368, 376, 404, 406, 431, 449, 460, 468, 490, 505, 516, 554, 575, 578, 582, 591, 603, 605, 607, 610, 615, 620, 630, 661, 679, 687])]),
'wjetstolnu_1j_2017': (238, ['/store/group/lpclonglived/pkotamni/WJetsToLNu_1J_TuneCP5_13TeV-amcatnloFXFX-pythia8/TrackMoverOffdzULV30LepMumv4_2017/240110_190915/0000/movedtree_%i.root' % i for i in chain(xrange(4,6), xrange(7,9), xrange(17,20), xrange(23,25), xrange(39,41), xrange(69,72), xrange(84,86), xrange(108,110), xrange(111,113), xrange(130,134), xrange(138,142), xrange(147,151), xrange(168,170), xrange(175,178), xrange(203,205), xrange(272,274), xrange(283,285), xrange(294,296), xrange(301,304), xrange(309,311), xrange(341,343), xrange(352,354), xrange(363,365), xrange(381,384), xrange(399,405), xrange(421,423), xrange(446,448), xrange(452,456), xrange(459,461), xrange(485,487), xrange(489,491), xrange(503,505), xrange(506,508), xrange(513,515), xrange(524,529), xrange(543,545), xrange(554,556), xrange(573,577), xrange(579,581), xrange(590,592), xrange(593,596), xrange(597,599), xrange(609,611), xrange(617,619), xrange(624,626), xrange(632,634), xrange(665,667), xrange(674,676), xrange(705,707), xrange(708,710), xrange(717,719), xrange(740,743), [2, 10, 15, 26, 31, 33, 35, 42, 46, 50, 61, 79, 87, 89, 94, 104, 128, 136, 143, 154, 157, 160, 172, 179, 182, 185, 191, 194, 198, 200, 206, 209, 211, 213, 215, 219, 223, 230, 239, 246, 248, 252, 255, 257, 270, 276, 278, 286, 297, 305, 307, 322, 331, 334, 338, 345, 347, 377, 389, 414, 426, 429, 434, 438, 468, 470, 479, 482, 498, 520, 522, 534, 536, 539, 558, 565, 567, 571, 582, 584, 587, 602, 604, 614, 627, 629, 640, 645, 647, 649, 651, 655, 657, 662, 668, 671, 677, 679, 683, 685, 693, 699, 721, 725, 728, 733, 737, 744, 747, 749])]),
'wjetstolnu_2j_2017': (100, ['/store/group/lpclonglived/pkotamni/WJetsToLNu_2J_TuneCP5_13TeV-amcatnloFXFX-pythia8/TrackMoverOffdzULV30LepMumv4_2017/240113_162712/0000/movedtree_%i.root' % i for i in chain(xrange(16,18), xrange(35,37), xrange(67,69), xrange(101,103), xrange(120,122), xrange(133,135), xrange(145,147), xrange(156,160), xrange(161,165), xrange(168,170), xrange(204,206), xrange(208,210), xrange(211,215), xrange(241,243), xrange(261,263), xrange(266,268), xrange(276,278), xrange(296,298), xrange(313,317), xrange(368,370), xrange(376,378), [5, 10, 20, 25, 31, 44, 46, 48, 50, 59, 71, 73, 78, 85, 92, 96, 105, 109, 117, 150, 152, 154, 179, 181, 185, 201, 217, 226, 229, 233, 236, 238, 251, 270, 291, 301, 307, 322, 327, 334, 338, 347, 349, 352, 354, 382, 384, 388, 390, 392])]),
'dyjetstollM10_2017': (371, ['/store/group/lpclonglived/pkotamni/DYJetsToLL_M-10to50_TuneCP5_13TeV-madgraphMLM-pythia8/TrackMoverOffdzULV30LepMumv4_2017/240110_190917/0000/movedtree_%i.root' % i for i in chain(xrange(9), xrange(10,15), xrange(16,61), xrange(62,90), xrange(91,99), xrange(100,108), xrange(109,132), xrange(133,166), xrange(167,195), xrange(196,232), xrange(233,264), xrange(265,279), xrange(280,282), xrange(283,300), xrange(301,312), xrange(313,332), xrange(333,342), xrange(343,361), xrange(362,371), xrange(372,390))]),
'dyjetstollM50_2017': (64, ['/store/group/lpclonglived/pkotamni/DYJetsToLL_M-50_TuneCP5_13TeV-madgraphMLM-pythia8/TrackMoverOffdzULV30LepMumv4_2017/240110_190918/0000/movedtree_%i.root' % i for i in chain(xrange(17,19), xrange(31,33), xrange(75,77), xrange(137,139), xrange(145,147), xrange(151,153), xrange(292,296), xrange(306,309), xrange(347,349), [11, 14, 26, 28, 41, 45, 47, 52, 60, 69, 71, 79, 91, 98, 100, 114, 116, 119, 122, 126, 162, 168, 177, 184, 196, 199, 203, 205, 216, 220, 224, 260, 274, 304, 317, 323, 325, 340, 354, 370, 386, 427, 433])]),
'ww_2017': (5, ['/store/group/lpclonglived/pkotamni/WW_TuneCP5_13TeV-pythia8/TrackMoverOffdzULV30LepMumv4_2017/240110_190920/0000/movedtree_%i.root' % i for i in chain(xrange(24,26), xrange(41,43), [33])]),
'zz_2017': (9, ['/store/group/lpclonglived/pkotamni/ZZ_TuneCP5_13TeV-pythia8/TrackMoverOffdzULV30LepMumv4_2017/240110_190921/0000/movedtree_%i.root' % i for i in chain(xrange(13,16), [1, 3, 6, 9, 18, 22])]),
'wz_2017': (1, ['/store/group/lpclonglived/pkotamni/WZ_TuneCP5_13TeV-pythia8/TrackMoverOffdzULV30LepMumv4_2017/240110_190922/0000/movedtree_23.root']),
})
...
_add_ds("trackmovermctruthoffdzulv30lepmumv4", {
'WplusHToSSTodddd_tau1mm_M55_2017': _fromnum1("/store/group/lpclonglived/pkotamni/WplusH_HToSSTodddd_WToLNu_MH-125_MS-55_ctauS-1_TuneCP5_13TeV-powheg-pythia8/TrackMoverMCTruthOffdzULV30LepMumv4_2017/240110_165349", 250, fnbase="mctruth"),
})
