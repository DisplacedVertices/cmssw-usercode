...
jmtUnpackedCandidateTracks = cms.EDProducer('JMTUnpackedCandidateTracks',
                                            ...
                                            separate_leptons = cms.bool(False), # Turning this off in this fork, but Abby uses this extensively
                                            add_lost_candidates = cms.bool(False), # as long as this is kept False, we're fine. if we want to use it in the future, see https://github.com/DisplacedVertices/cmssw-usercode/pull/25#discussion_r1767609863
